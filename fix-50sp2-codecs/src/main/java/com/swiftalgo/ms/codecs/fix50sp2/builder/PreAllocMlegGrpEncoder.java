...
public class PreAllocMlegGrpEncoder
{
...
public static class AllocsGroupEncoder
{
    ...
    public PreAllocMlegGrpEncoder noAllocsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"PreAllocMlegGrp\",\n");
        if (hasNoAllocsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public PreAllocMlegGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((PreAllocMlegGrpEncoder)encoder);
    }

    public PreAllocMlegGrpEncoder copyTo(final PreAllocMlegGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoAllocsGroupCounter)
        {
