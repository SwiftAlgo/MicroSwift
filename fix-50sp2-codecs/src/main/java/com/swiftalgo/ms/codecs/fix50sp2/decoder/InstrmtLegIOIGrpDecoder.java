...
public interface InstrmtLegIOIGrpDecoder 
{
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder
{
     ...
     * {@inheritDoc}
     */
    public InstrmtLegIOIGrpEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((InstrmtLegIOIGrpEncoder.LegsGroupEncoder)encoder);
    }

    public InstrmtLegIOIGrpEncoder.LegsGroupEncoder toEncoder(final InstrmtLegIOIGrpEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final InstrmtLegIOIGrpDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final InstrmtLegIOIGrpDecoder parent)
        {
            this.parent = parent;
        }
