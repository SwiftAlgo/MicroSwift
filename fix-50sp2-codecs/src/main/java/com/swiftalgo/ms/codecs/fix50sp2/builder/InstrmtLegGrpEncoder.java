...
public class InstrmtLegGrpEncoder
{
...
public static class LegsGroupEncoder
{
    ...
    public InstrmtLegGrpEncoder noLegsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"InstrmtLegGrp\",\n");
        if (hasNoLegsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public InstrmtLegGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((InstrmtLegGrpEncoder)encoder);
    }

    public InstrmtLegGrpEncoder copyTo(final InstrmtLegGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoLegsGroupCounter)
        {
