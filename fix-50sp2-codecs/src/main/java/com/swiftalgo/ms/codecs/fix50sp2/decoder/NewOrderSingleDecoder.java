...
import com.swiftalgo.ms.codecs.fix50sp2.builder.NewOrderSingleEncoder;
...
public class NewOrderSingleDecoder extends CommonDecoderImpl implements PartiesDecoder, PreAllocGrpDecoder, DisplayInstructionDecoder, TrdgSesGrpDecoder, InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, StipulationsDecoder, OrderQtyDataDecoder, TriggeringInstructionDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, CommissionDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, StrategyParametersGrpDecoder, TrdRegTimestampsDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(464);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(464);
