...
public class StrmAsgnReqGrpEncoder
{
...
public static class AsgnReqsGroupEncoder
{
    ...
    private final StrmAsgnReqInstrmtGrpEncoder strmAsgnReqInstrmtGrp = new StrmAsgnReqInstrmtGrpEncoder();
    public StrmAsgnReqInstrmtGrpEncoder strmAsgnReqInstrmtGrp()
    {
        return strmAsgnReqInstrmtGrp;
    }
    ...
    public int encode(final MutableAsciiBuffer buffer, final int offset, final int remainingElements)
    {
        ...
        int position = offset;
            ...
            position += strmAsgnReqInstrmtGrp.encode(buffer, position);
        if (next != null)
        {
    ...
    indent(builder, level);
    builder.append("\"StrmAsgnReqInstrmtGrp\": ");
    strmAsgnReqInstrmtGrp.appendTo(builder, level + 1);
    builder.append("\n");
    ...
    public AsgnReqsGroupEncoder copyTo(final AsgnReqsGroupEncoder encoder)
    {
        ...
        strmAsgnReqInstrmtGrp.copyTo(encoder.strmAsgnReqInstrmtGrp());        return encoder;
    }
    ...
    public StrmAsgnReqGrpEncoder noAsgnReqsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"StrmAsgnReqGrp\",\n");
        if (hasNoAsgnReqsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public StrmAsgnReqGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((StrmAsgnReqGrpEncoder)encoder);
    }

    public StrmAsgnReqGrpEncoder copyTo(final StrmAsgnReqGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoAsgnReqsGroupCounter)
        {
