...
import com.swiftalgo.ms.codecs.fix50sp2.builder.TradingSessionStatusEncoder;
...
public class TradingSessionStatusDecoder extends CommonDecoderImpl implements ApplicationSequenceControlDecoder, InstrumentDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(216);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.TRAD_SES_EVENT);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(216);
    ...
    public boolean validate()
    {
        ...
        if (hasTradSesEvent)
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !TradSesEvent.isValid(tradSesEvent()))
        {
            invalidTagId = 1368;
            rejectReason = 5;
            return false;
    ...
    public final IntHashSet messageFields = new IntHashSet(340);

    {
        ...
        messageFields.add(Constants.TRAD_SES_EVENT);
 ...
 return TradSesMode.NULL_VAL;
    ...
    private int tradSesEvent = MISSING_INT;
    ...
    public int tradSesEvent()
    {
        if (!hasTradSesEvent)
        {
            throw new IllegalArgumentException("No value for optional field: TradSesEvent");
        }
    ...
    private final CharArrayWrapper tradSesEventWrapper = new CharArrayWrapper();
    public TradSesEvent tradSesEventAsEnum()
    {
        if (!hasTradSesEvent)
 return TradSesEvent.NULL_VAL;
        return TradSesEvent.decode(tradSesEvent);
    }
 ...
 return CPProgram.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.TRAD_SES_EVENT:
                hasTradSesEvent = true;
                tradSesEvent = getInt(buffer, valueOffset, endOfField, 1368, CODEC_VALIDATION_ENABLED);
                break;
