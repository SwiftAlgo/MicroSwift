...
public interface InstrmtGrpDecoder 
{
...
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(168);
 ...
 return CPProgram.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public InstrmtGrpEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((InstrmtGrpEncoder.RelatedSymGroupEncoder)encoder);
    }

    public InstrmtGrpEncoder.RelatedSymGroupEncoder toEncoder(final InstrmtGrpEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final InstrmtGrpDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final InstrmtGrpDecoder parent)
        {
            this.parent = parent;
        }
