...
public class AllocsGroupDecoder extends CommonDecoderImpl implements NestedPartiesDecoder, CommissionDataDecoder, MiscFeesGrpDecoder, ClrInstGrpDecoder, SettlInstructionsDataDecoder
{
 ...
 return StandInstDbType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public AllocGrpEncoder.AllocsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocGrpEncoder.AllocsGroupEncoder)encoder);
    }

    public AllocGrpEncoder.AllocsGroupEncoder toEncoder(final AllocGrpEncoder.AllocsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasAllocAccount())
        {
