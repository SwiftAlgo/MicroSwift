...
public class SecLstUpdRelSymGrpEncoder
{
...
public static class RelatedSymGroupEncoder
{
    ...
    private static final int listUpdateActionHeaderLength = 5;
    private static final byte[] listUpdateActionHeader = new byte[] {49, 51, 50, 52, (byte) '='};
    ...
    public RelatedSymGroupEncoder listUpdateAction(char value)
    {
        listUpdateAction = value;
    ...
    private final SecLstUpdRelSymsLegGrpEncoder secLstUpdRelSymsLegGrp = new SecLstUpdRelSymsLegGrpEncoder();
    public SecLstUpdRelSymsLegGrpEncoder secLstUpdRelSymsLegGrp()
    {
        return secLstUpdRelSymsLegGrp;
    }
    ...
    public int encode(final MutableAsciiBuffer buffer, final int offset, final int remainingElements)
    {
        ...
        {
            buffer.putBytes(position, listUpdateActionHeader, 0, listUpdateActionHeaderLength);
            position += listUpdateActionHeaderLength;
            position += buffer.putCharAscii(position, listUpdateAction);
        ...
        if (currencyLength > 0)
        {
            ...
            position += secLstUpdRelSymsLegGrp.encode(buffer, position);
    ...
    indent(builder, level);
    builder.append("\"SecLstUpdRelSymsLegGrp\": ");
    secLstUpdRelSymsLegGrp.appendTo(builder, level + 1);
    builder.append("\n");
    ...
    public RelatedSymGroupEncoder copyTo(final RelatedSymGroupEncoder encoder)
    {
        ...
        secLstUpdRelSymsLegGrp.copyTo(encoder.secLstUpdRelSymsLegGrp());
    ...
    public SecLstUpdRelSymGrpEncoder noRelatedSymGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"SecLstUpdRelSymGrp\",\n");
        if (hasNoRelatedSymGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public SecLstUpdRelSymGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((SecLstUpdRelSymGrpEncoder)encoder);
    }

    public SecLstUpdRelSymGrpEncoder copyTo(final SecLstUpdRelSymGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoRelatedSymGroupCounter)
        {
