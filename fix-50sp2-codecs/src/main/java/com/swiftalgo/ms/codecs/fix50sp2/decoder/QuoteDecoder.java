...
import com.swiftalgo.ms.codecs.fix50sp2.builder.QuoteEncoder;
...
import com.swiftalgo.ms.codecs.fix50sp2.builder.LegQuotGrpEncoder;
import static com.swiftalgo.ms.codecs.fix50sp2.builder.LegQuotGrpEncoder.LegsGroupEncoder;
...
public class QuoteDecoder extends CommonDecoderImpl implements QuotQualGrpDecoder, PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, OrderQtyDataDecoder, RateSourceDecoder, StipulationsDecoder, LegQuotGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.BID_SWAP_POINTS);
            GROUP_FIELDS.add(Constants.OFFER_SWAP_POINTS);
    ...
    public final IntHashSet messageFields = new IntHashSet(828);

    {
        ...
        messageFields.add(Constants.LEG_BID_FORWARD_POINTS);
        messageFields.add(Constants.LEG_OFFER_FORWARD_POINTS);
        ...
        messageFields.add(Constants.BID_SWAP_POINTS);
        messageFields.add(Constants.OFFER_SWAP_POINTS);
 ...
 return AccountType.NULL_VAL;
    ...
    private DecimalFloat bidSwapPoints = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat bidSwapPoints()
    {
        if (!hasBidSwapPoints)
        {
            throw new IllegalArgumentException("No value for optional field: BidSwapPoints");
        }
    ...
    private DecimalFloat offerSwapPoints = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat offerSwapPoints()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: OfferSwapPoints");
        }
 ...
 return YieldType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.BID_SWAP_POINTS:
                hasBidSwapPoints = true;
                bidSwapPoints = getFloat(buffer, bidSwapPoints, valueOffset, valueLength, 1065, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.OFFER_SWAP_POINTS:
                hasOfferSwapPoints = true;
                offerSwapPoints = getFloat(buffer, offerSwapPoints, valueOffset, valueLength, 1066, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public QuoteEncoder toEncoder(final QuoteEncoder encoder)
    {
        ...
        final QuotQualGrpEncoder quotQualGrp = encoder.quotQualGrp();        if (hasNoQuoteQualifiersGroupCounter)
        {
            final int size = this.noQuoteQualifiersGroupCounter;
            QuoteQualifiersGroupDecoder quoteQualifiersGroup = this.quoteQualifiersGroup;
            QuoteQualifiersGroupEncoder quoteQualifiersGroupEncoder = quotQualGrp.quoteQualifiersGroup(size);
        ...
        final LegQuotGrpEncoder legQuotGrp = encoder.legQuotGrp();        if (hasNoLegsGroupCounter)
        {
            final int size = this.noLegsGroupCounter;
            LegsGroupDecoder legsGroup = this.legsGroup;
            LegsGroupEncoder legsGroupEncoder = legQuotGrp.legsGroup(size);
            for (int i = 0; i < size; i++)
            {
                if (legsGroup != null)
                {
