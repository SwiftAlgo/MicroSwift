...
public class SecurityTypeRequestEncoder implements Encoder
{
    ...
    public SecurityTypeRequestEncoder marketID(final DirectBuffer value, final int offset, final int length)
    {
        marketID.wrap(value);
    ...
    public SecurityTypeRequestEncoder marketID(final DirectBuffer value, final int length)
    {
        return marketID(value, 0, length);
    }

    public SecurityTypeRequestEncoder marketID(final DirectBuffer value)
    {
        return marketID(value, 0, value.capacity());
    }

    public SecurityTypeRequestEncoder marketID(final byte[] value, final int offset, final int length)
    {
        marketID.wrap(value);
        marketIDOffset = offset;
        marketIDLength = length;
    ...
    public SecurityTypeRequestEncoder marketIDAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public SecurityTypeRequestEncoder marketID(final byte[] value, final int length)
    {
        return marketID(value, 0, length);
    }

    public SecurityTypeRequestEncoder marketID(final byte[] value)
    {
    ...
    public SecurityTypeRequestEncoder marketID(final CharSequence value)
    {
    ...
    public SecurityTypeRequestEncoder marketID(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public SecurityTypeRequestEncoder marketID(final char[] value)
    {
        return marketID(value, 0, value.length);
    }

    public SecurityTypeRequestEncoder marketID(final char[] value, final int length)
    {
        return marketID(value, 0, length);
    }

    public SecurityTypeRequestEncoder marketID(final char[] value, final int offset, final int length)
    {
    ...
    public SecurityTypeRequestEncoder marketSegmentID(final DirectBuffer value, final int offset, final int length)
    {
    ...
    public SecurityTypeRequestEncoder marketSegmentID(final DirectBuffer value, final int length)
    {
        return marketSegmentID(value, 0, length);
    }

    public SecurityTypeRequestEncoder marketSegmentID(final DirectBuffer value)
    {
        return marketSegmentID(value, 0, value.capacity());
    }

    public SecurityTypeRequestEncoder marketSegmentID(final byte[] value, final int offset, final int length)
    {
        marketSegmentID.wrap(value);
        marketSegmentIDOffset = offset;
        marketSegmentIDLength = length;
    ...
    public SecurityTypeRequestEncoder marketSegmentIDAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public SecurityTypeRequestEncoder marketSegmentID(final byte[] value, final int length)
    {
        return marketSegmentID(value, 0, length);
    }

    public SecurityTypeRequestEncoder marketSegmentID(final byte[] value)
    {
    ...
    public SecurityTypeRequestEncoder marketSegmentID(final CharSequence value)
    {
    ...
    public SecurityTypeRequestEncoder marketSegmentID(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public SecurityTypeRequestEncoder marketSegmentID(final char[] value)
    {
        return marketSegmentID(value, 0, value.length);
    }

    public SecurityTypeRequestEncoder marketSegmentID(final char[] value, final int length)
    {
        return marketSegmentID(value, 0, length);
    }

    public SecurityTypeRequestEncoder marketSegmentID(final char[] value, final int offset, final int length)
    {
    ...
    public SecurityTypeRequestEncoder tradingSessionID(TradingSessionID value)
    {
    ...
    public SecurityTypeRequestEncoder tradingSessionSubID(TradingSessionSubID value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
