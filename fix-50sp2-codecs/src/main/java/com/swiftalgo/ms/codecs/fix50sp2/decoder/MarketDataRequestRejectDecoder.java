...
import com.swiftalgo.ms.codecs.fix50sp2.builder.MarketDataRequestRejectEncoder;
...
public class MarketDataRequestRejectDecoder extends CommonDecoderImpl implements PartiesDecoder, MDRjctGrpDecoder, MessageDecoder
{
 ...
 return MDReqRejReason.NULL_VAL;
    ...
    public MarketDataRequestRejectEncoder toEncoder(final MarketDataRequestRejectEncoder encoder)
    {
        ...
        final MDRjctGrpEncoder mDRjctGrp = encoder.mDRjctGrp();        if (hasNoAltMDSourceGroupCounter)
        {
            final int size = this.noAltMDSourceGroupCounter;
            AltMDSourceGroupDecoder altMDSourceGroup = this.altMDSourceGroup;
            AltMDSourceGroupEncoder altMDSourceGroupEncoder = mDRjctGrp.altMDSourceGroup(size);
            for (int i = 0; i < size; i++)
            {
                if (altMDSourceGroup != null)
                {
