...
import com.swiftalgo.ms.codecs.fix50sp2.builder.ConfirmationEncoder;
...
public class ConfirmationDecoder extends CommonDecoderImpl implements PartiesDecoder, OrdAllocGrpDecoder, TrdRegTimestampsDecoder, InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder, YieldDataDecoder, CpctyConfGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, SettlInstructionsDataDecoder, CommissionDataDecoder, StipulationsDecoder, MiscFeesGrpDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.NO_CAPACITIES);
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(334);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(334);
    ...
    public final IntHashSet messageFields = new IntHashSet(848);

    {
        ...
        messageFields.add(Constants.NO_CAPACITIES);
    ...
    public void confirmRefID(final AsciiSequenceView view)
    {
        if (!hasConfirmRefID)
        {
            throw new IllegalArgumentException("No value for optional field: ConfirmRefID");
        ...
        view.wrap(buffer, confirmRefIDOffset, confirmRefIDLength);
    }
 ...
 return FundRenewWaiv.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.REPORTED_PX:
                hasReportedPx = true;
                reportedPx = getFloat(buffer, reportedPx, valueOffset, valueLength, 861, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.MATURITY_NET_MONEY:
                ...
                maturityNetMoney = getFloat(buffer, maturityNetMoney, valueOffset, valueLength, 890, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.SHARED_COMMISSION:
                ...
                sharedCommission = getFloat(buffer, sharedCommission, valueOffset, valueLength, 858, CODEC_VALIDATION_ENABLED);
                break;
    ...
    if (hasNoCapacitiesGroupCounter)
    {
        ...
        {
            indent(builder, level);
            capacitiesGroup.appendTo(builder, level + 1);            if (capacitiesGroup.next() != null)
            {
                builder.append(',');
            }
            builder.append('\n');
    ...
    public ConfirmationEncoder toEncoder(final ConfirmationEncoder encoder)
    {
        ...
        final CpctyConfGrpEncoder cpctyConfGrp = encoder.cpctyConfGrp();        if (hasNoCapacitiesGroupCounter)
        {
            final int size = this.noCapacitiesGroupCounter;
            CapacitiesGroupDecoder capacitiesGroup = this.capacitiesGroup;
            CapacitiesGroupEncoder capacitiesGroupEncoder = cpctyConfGrp.capacitiesGroup(size);
            for (int i = 0; i < size; i++)
            {
                if (capacitiesGroup != null)
                {
