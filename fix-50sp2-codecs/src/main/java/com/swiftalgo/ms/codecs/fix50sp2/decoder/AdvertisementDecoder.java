...
import com.swiftalgo.ms.codecs.fix50sp2.builder.AdvertisementEncoder;
...
public class AdvertisementDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrmtLegGrpDecoder, UndInstrmtGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(606);
    ...
    public void advId(final AsciiSequenceView view)
    {
        view.wrap(buffer, advIdOffset, advIdLength);
    }
    ...
    public void advTransType(final AsciiSequenceView view)
    {
        view.wrap(buffer, advTransTypeOffset, advTransTypeLength);
    }
    ...
    public void advRefID(final AsciiSequenceView view)
    {
        if (!hasAdvRefID)
        {
            throw new IllegalArgumentException("No value for optional field: AdvRefID");
        ...
        view.wrap(buffer, advRefIDOffset, advRefIDLength);
    }
