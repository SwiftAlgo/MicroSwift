...
public enum OrigCustOrderCapacity implements IntRepresentable
{
    ...
    OrigCustOrderCapacity(final int representation)
    {
    ...
    public static OrigCustOrderCapacity decode(final int representation)
    {
