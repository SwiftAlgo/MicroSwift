 ...
 return UnderlyingFXRateCalc.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.NO_UNDERLYING_AMOUNTS_GROUP_COUNTER:
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasNoUnderlyingAmountsGroupCounter)
        {
            ...
            for (int i = 0, size = this.noUnderlyingAmountsGroupCounter; i < size; i++)
            {
                ...
                if (underlyingAmountsGroup.next() != null)
                {
                    builder.append(',');
                }
                builder.append('\n');
     ...
     * {@inheritDoc}
     */
    public PosUndInstrmtGrpEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PosUndInstrmtGrpEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public PosUndInstrmtGrpEncoder.UnderlyingsGroupEncoder toEncoder(final PosUndInstrmtGrpEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
