...
public interface RelSymDerivSecUpdGrpDecoder 
{



public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, SecondaryPriceLimitsDecoder, InstrmtLegGrpDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.LIST_UPDATE_ACTION);
            ...
            GROUP_FIELDS.add(Constants.SECONDARY_PRICE_LIMIT_TYPE);
            GROUP_FIELDS.add(Constants.SECONDARY_LOW_LIMIT_PRICE);
            GROUP_FIELDS.add(Constants.SECONDARY_HIGH_LIMIT_PRICE);
            GROUP_FIELDS.add(Constants.SECONDARY_TRADING_REFERENCE_PRICE);
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ALL_GROUP_FIELDS.add(Constants.LIST_UPDATE_ACTION);
    ...
    private char listUpdateAction = MISSING_CHAR;

    private boolean hasListUpdateAction;

    public char listUpdateAction()
    {
        if (!hasListUpdateAction)
        {
            throw new IllegalArgumentException("No value for optional field: ListUpdateAction");
        }

        return listUpdateAction;
    }

    public boolean hasListUpdateAction()
    {
        return hasListUpdateAction;
    }
 ...
 return DeliveryForm.NULL_VAL;
    ...
    private int secondaryPriceLimitType = MISSING_INT;
    ...
    public int secondaryPriceLimitType()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: SecondaryPriceLimitType");
        }
    ...
    private DecimalFloat secondaryLowLimitPrice = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat secondaryLowLimitPrice()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: SecondaryLowLimitPrice");
        }
    ...
    private DecimalFloat secondaryHighLimitPrice = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat secondaryHighLimitPrice()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: SecondaryHighLimitPrice");
        }
    ...
    private DecimalFloat secondaryTradingReferencePrice = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat secondaryTradingReferencePrice()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: SecondaryTradingReferencePrice");
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.LIST_UPDATE_ACTION:
                hasListUpdateAction = true;
                listUpdateAction = buffer.getChar(valueOffset);
                break;
            ...
            case Constants.SECONDARY_PRICE_LIMIT_TYPE:
                hasSecondaryPriceLimitType = true;
                secondaryPriceLimitType = getInt(buffer, valueOffset, endOfField, 1305, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.SECONDARY_LOW_LIMIT_PRICE:
                hasSecondaryLowLimitPrice = true;
                secondaryLowLimitPrice = getFloat(buffer, secondaryLowLimitPrice, valueOffset, valueLength, 1221, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.SECONDARY_HIGH_LIMIT_PRICE:
                hasSecondaryHighLimitPrice = true;
                secondaryHighLimitPrice = getFloat(buffer, secondaryHighLimitPrice, valueOffset, valueLength, 1230, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.SECONDARY_TRADING_REFERENCE_PRICE:
                hasSecondaryTradingReferencePrice = true;
                secondaryTradingReferencePrice = getFloat(buffer, secondaryTradingReferencePrice, valueOffset, valueLength, 1240, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public void resetListUpdateAction()
    {
        hasListUpdateAction = false;
    }
     ...
     * {@inheritDoc}
     */
    public RelSymDerivSecUpdGrpEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RelSymDerivSecUpdGrpEncoder.RelatedSymGroupEncoder)encoder);
    }

    public RelSymDerivSecUpdGrpEncoder.RelatedSymGroupEncoder toEncoder(final RelSymDerivSecUpdGrpEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
        if (hasListUpdateAction())
        {
            encoder.listUpdateAction(this.listUpdateAction());
        }
        ...
        final SecondaryPriceLimitsEncoder secondaryPriceLimits = encoder.secondaryPriceLimits();        if (hasSecondaryPriceLimitType())
        {
            secondaryPriceLimits.secondaryPriceLimitType(this.secondaryPriceLimitType());
        }

        if (hasSecondaryLowLimitPrice())
        {
            secondaryPriceLimits.secondaryLowLimitPrice(this.secondaryLowLimitPrice());
        }

        if (hasSecondaryHighLimitPrice())
        {
            secondaryPriceLimits.secondaryHighLimitPrice(this.secondaryHighLimitPrice());
        }

        if (hasSecondaryTradingReferencePrice())
        {
            secondaryPriceLimits.secondaryTradingReferencePrice(this.secondaryTradingReferencePrice());
        }
    ...
    {
        private final RelSymDerivSecUpdGrpDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final RelSymDerivSecUpdGrpDecoder parent)
        {
            this.parent = parent;
        }
