...
import com.swiftalgo.ms.codecs.fix50sp2.builder.QuotReqGrpEncoder;
import static com.swiftalgo.ms.codecs.fix50sp2.builder.QuotReqGrpEncoder.RelatedSymGroupEncoder;
...
public interface QuotReqGrpDecoder 
{



public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, OrderQtyDataDecoder, RateSourceDecoder, StipulationsDecoder, QuotReqLegsGrpDecoder, QuotQualGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, PartiesDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(276);
    ...
    public final IntHashSet ALL_GROUP_FIELDS = new IntHashSet(52);
    ...
    private IntHashSet seenFields = new IntHashSet(74);
 ...
 return YieldType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public QuotReqGrpEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuotReqGrpEncoder.RelatedSymGroupEncoder)encoder);
    }

    public QuotReqGrpEncoder.RelatedSymGroupEncoder toEncoder(final QuotReqGrpEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
        ...
        final QuotReqLegsGrpEncoder quotReqLegsGrp = encoder.quotReqLegsGrp();        if (hasNoLegsGroupCounter)
        {
            final int size = this.noLegsGroupCounter;
            LegsGroupDecoder legsGroup = this.legsGroup;
            LegsGroupEncoder legsGroupEncoder = quotReqLegsGrp.legsGroup(size);
            for (int i = 0; i < size; i++)
            {
                if (legsGroup != null)
                {
    ...
    {
        private final QuotReqGrpDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final QuotReqGrpDecoder parent)
        {
            this.parent = parent;
        }
