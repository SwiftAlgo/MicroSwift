...
public class AssignmentReportEncoder implements Encoder
{
    ...
    public AssignmentReportEncoder posReqID(final DirectBuffer value, final int offset, final int length)
    {
        posReqID.wrap(value);
    ...
    public AssignmentReportEncoder posReqID(final DirectBuffer value, final int length)
    {
        return posReqID(value, 0, length);
    }

    public AssignmentReportEncoder posReqID(final DirectBuffer value)
    {
        return posReqID(value, 0, value.capacity());
    }

    public AssignmentReportEncoder posReqID(final byte[] value, final int offset, final int length)
    {
        posReqID.wrap(value);
        posReqIDOffset = offset;
        posReqIDLength = length;
    ...
    public AssignmentReportEncoder posReqIDAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public AssignmentReportEncoder posReqID(final byte[] value, final int length)
    {
        return posReqID(value, 0, length);
    }

    public AssignmentReportEncoder posReqID(final byte[] value)
    {
    ...
    public AssignmentReportEncoder posReqID(final CharSequence value)
    {
    ...
    public AssignmentReportEncoder posReqID(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public AssignmentReportEncoder posReqID(final char[] value)
    {
        return posReqID(value, 0, value.length);
    }

    public AssignmentReportEncoder posReqID(final char[] value, final int length)
    {
        return posReqID(value, 0, length);
    }

    public AssignmentReportEncoder posReqID(final char[] value, final int offset, final int length)
    {
    ...
    public AssignmentReportEncoder priorSettlPrice(DecimalFloat value)
    {
    ...
    public AssignmentReportEncoder priorSettlPrice(long value, int scale)
    {
    ...
    public AssignmentReportEncoder settlSessID(SettlSessID value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
