...
public class CompIDStatGrpEncoder
{
...
public static class CompIDsGroupEncoder
{
    ...
    public int encode(final MutableAsciiBuffer buffer, final int offset, final int remainingElements)
    {
        ...
        {
            throw new EncodingException("Missing Field: RefCompID");
        }
        ...
        {
            throw new EncodingException("Missing Field: StatusValue");
        }
    ...
    public CompIDStatGrpEncoder noCompIDsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"CompIDStatGrp\",\n");
        if (hasNoCompIDsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public CompIDStatGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((CompIDStatGrpEncoder)encoder);
    }

    public CompIDStatGrpEncoder copyTo(final CompIDStatGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoCompIDsGroupCounter)
        {
