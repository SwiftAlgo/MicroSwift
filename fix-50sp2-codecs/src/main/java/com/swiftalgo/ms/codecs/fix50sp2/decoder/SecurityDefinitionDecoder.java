...
import com.swiftalgo.ms.codecs.fix50sp2.builder.SecurityDefinitionEncoder;
...
public class SecurityDefinitionDecoder extends CommonDecoderImpl implements ApplicationSequenceControlDecoder, InstrumentDecoder, InstrumentExtensionDecoder, UndInstrmtGrpDecoder, StipulationsDecoder, InstrmtLegGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MarketSegmentGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(230);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(230);
    ...
    public final IntHashSet messageFields = new IntHashSet(760);
