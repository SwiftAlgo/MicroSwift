...
import com.swiftalgo.ms.codecs.fix50sp2.builder.RequestForPositionsEncoder;
...
public class RequestForPositionsDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, InstrmtLegGrpDecoder, UndInstrmtGrpDecoder, TrdgSesGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(204);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(204);
