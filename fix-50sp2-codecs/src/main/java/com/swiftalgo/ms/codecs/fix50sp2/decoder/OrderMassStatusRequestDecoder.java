...
import com.swiftalgo.ms.codecs.fix50sp2.builder.OrderMassStatusRequestEncoder;
...
public class OrderMassStatusRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, TargetPartiesDecoder, InstrumentDecoder, UnderlyingInstrumentDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(320);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(320);
    ...
    public final IntHashSet messageFields = new IntHashSet(492);
