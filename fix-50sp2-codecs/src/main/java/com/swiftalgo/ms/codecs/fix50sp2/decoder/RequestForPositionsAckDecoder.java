...
import com.swiftalgo.ms.codecs.fix50sp2.builder.RequestForPositionsAckEncoder;
...
public class RequestForPositionsAckDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, InstrmtLegGrpDecoder, UndInstrmtGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(212);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(212);
