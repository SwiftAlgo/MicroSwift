...
import com.swiftalgo.ms.codecs.fix50sp2.builder.OrderMassCancelRequestEncoder;
...
public class OrderMassCancelRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, TargetPartiesDecoder, InstrumentDecoder, UnderlyingInstrumentDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(330);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(330);
