...
public interface LegQuotGrpDecoder 
{
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, NestedPartiesDecoder, LegBenchmarkCurveDataDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(138);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.LEG_BID_FORWARD_POINTS);
            GROUP_FIELDS.add(Constants.LEG_OFFER_FORWARD_POINTS);
        }
    }
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            ALL_GROUP_FIELDS.add(Constants.LEG_BID_FORWARD_POINTS);
            ALL_GROUP_FIELDS.add(Constants.LEG_OFFER_FORWARD_POINTS);
        }
    }
 ...
 return LegSwapType.NULL_VAL;
    ...
    public DecimalFloat legBidForwardPoints()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: LegBidForwardPoints");
        }
    ...
    private DecimalFloat legOfferForwardPoints = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat legOfferForwardPoints()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: LegOfferForwardPoints");
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.LEG_BID_FORWARD_POINTS:
                hasLegBidForwardPoints = true;
                legBidForwardPoints = getFloat(buffer, legBidForwardPoints, valueOffset, valueLength, 1067, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.LEG_OFFER_FORWARD_POINTS:
                hasLegOfferForwardPoints = true;
                legOfferForwardPoints = getFloat(buffer, legOfferForwardPoints, valueOffset, valueLength, 1068, CODEC_VALIDATION_ENABLED);
                break;
    ...
    {
        private final LegQuotGrpDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final LegQuotGrpDecoder parent)
        {
            this.parent = parent;
        }
