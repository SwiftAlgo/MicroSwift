...
import com.swiftalgo.ms.codecs.fix50sp2.builder.CollateralInquiryEncoder;
...
public class CollateralInquiryDecoder extends CommonDecoderImpl implements CollInqQualGrpDecoder, PartiesDecoder, ExecCollGrpDecoder, TrdCollGrpDecoder, InstrumentDecoder, FinancingDetailsDecoder, InstrmtLegGrpDecoder, UndInstrmtGrpDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, SettlInstructionsDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(274);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(274);
    ...
    public final IntHashSet messageFields = new IntHashSet(746);

    {
        ...
        messageFields.add(Constants.NO_COLL_INQUIRY_QUALIFIER);
    ...
    public void collInquiryID(final AsciiSequenceView view)
    {
        view.wrap(buffer, collInquiryIDOffset, collInquiryIDLength);
    }
 ...
 return SettlSessID.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.NO_COLL_INQUIRY_QUALIFIER:
    ...
    if (hasNoCollInquiryQualifierGroupCounter)
    {
        ...
        {
            indent(builder, level);
            collInquiryQualifierGroup.appendTo(builder, level + 1);            if (collInquiryQualifierGroup.next() != null)
            {
                builder.append(',');
            }
            builder.append('\n');
    ...
    public CollateralInquiryEncoder toEncoder(final CollateralInquiryEncoder encoder)
    {
        ...
        final CollInqQualGrpEncoder collInqQualGrp = encoder.collInqQualGrp();        if (hasNoCollInquiryQualifierGroupCounter)
        {
            final int size = this.noCollInquiryQualifierGroupCounter;
            CollInquiryQualifierGroupDecoder collInquiryQualifierGroup = this.collInquiryQualifierGroup;
            CollInquiryQualifierGroupEncoder collInquiryQualifierGroupEncoder = collInqQualGrp.collInquiryQualifierGroup(size);
