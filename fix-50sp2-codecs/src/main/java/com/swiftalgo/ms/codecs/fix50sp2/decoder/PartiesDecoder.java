...
public class PartyIDsGroupDecoder extends CommonDecoderImpl implements PtysSubGrpDecoder
{
 ...
 return PartyRole.NULL_VAL;
    ...
    public PartiesEncoder.PartyIDsGroupEncoder toEncoder(final PartiesEncoder.PartyIDsGroupEncoder encoder)
    {
        ...
        final PtysSubGrpEncoder ptysSubGrp = encoder.ptysSubGrp();        if (hasNoPartySubIDsGroupCounter)
        {
            final int size = this.noPartySubIDsGroupCounter;
            PartySubIDsGroupDecoder partySubIDsGroup = this.partySubIDsGroup;
            PartySubIDsGroupEncoder partySubIDsGroupEncoder = ptysSubGrp.partySubIDsGroup(size);
