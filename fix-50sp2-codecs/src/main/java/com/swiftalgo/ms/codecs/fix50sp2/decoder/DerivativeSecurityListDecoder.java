...
import com.swiftalgo.ms.codecs.fix50sp2.builder.DerivativeSecurityListEncoder;
...
import com.swiftalgo.ms.codecs.fix50sp2.builder.RelSymDerivSecGrpEncoder;
import static com.swiftalgo.ms.codecs.fix50sp2.builder.RelSymDerivSecGrpEncoder.RelatedSymGroupEncoder;
...
public class DerivativeSecurityListDecoder extends CommonDecoderImpl implements ApplicationSequenceControlDecoder, UnderlyingInstrumentDecoder, DerivativeSecurityDefinitionDecoder, RelSymDerivSecGrpDecoder, MessageDecoder
{
 ...
 return UnderlyingFXRateCalc.NULL_VAL;
    ...
    public DerivativeSecurityListEncoder toEncoder(final DerivativeSecurityListEncoder encoder)
    {
        ...
        final RelSymDerivSecGrpEncoder relSymDerivSecGrp = encoder.relSymDerivSecGrp();        if (hasNoRelatedSymGroupCounter)
        {
            final int size = this.noRelatedSymGroupCounter;
            RelatedSymGroupDecoder relatedSymGroup = this.relatedSymGroup;
            RelatedSymGroupEncoder relatedSymGroupEncoder = relSymDerivSecGrp.relatedSymGroup(size);
            for (int i = 0; i < size; i++)
            {
                if (relatedSymGroup != null)
                {
