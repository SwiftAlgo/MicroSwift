...
import com.swiftalgo.ms.codecs.fix50sp2.builder.DontKnowTradeEncoder;
...
public class DontKnowTradeDecoder extends CommonDecoderImpl implements InstrumentDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder, OrderQtyDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(198);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(198);
    ...
    public final IntHashSet messageFields = new IntHashSet(602);
