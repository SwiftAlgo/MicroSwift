...
import com.swiftalgo.ms.codecs.fix50sp2.builder.AssignmentReportEncoder;
...
public class AssignmentReportDecoder extends CommonDecoderImpl implements ApplicationSequenceControlDecoder, PartiesDecoder, InstrumentDecoder, InstrmtLegGrpDecoder, UndInstrmtGrpDecoder, PositionQtyDecoder, PositionAmountDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(222);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(222);
    ...
    public final IntHashSet messageFields = new IntHashSet(674);
    ...
    public void asgnRptID(final AsciiSequenceView view)
    {
        view.wrap(buffer, asgnRptIDOffset, asgnRptIDLength);
    }
 ...
 return SettlPriceType.NULL_VAL;
    ...
    public char assignmentMethod()
    {
        if (!hasAssignmentMethod)
        {
            throw new IllegalArgumentException("No value for optional field: AssignmentMethod");
        }
    ...
    {
        if (!hasAssignmentMethod)
 return AssignmentMethod.NULL_VAL;
    ...
    public DecimalFloat openInterest()
    {
        if (!hasOpenInterest)
        {
            throw new IllegalArgumentException("No value for optional field: OpenInterest");
        }
    ...
    public char exerciseMethod()
    {
        if (!hasExerciseMethod)
        {
            throw new IllegalArgumentException("No value for optional field: ExerciseMethod");
        }
    ...
    {
        if (!hasExerciseMethod)
 return ExerciseMethod.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.THRESHOLD_AMOUNT:
                ...
                thresholdAmount = getFloat(buffer, thresholdAmount, valueOffset, valueLength, 834, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.ASSIGNMENT_UNIT:
                ...
                assignmentUnit = getFloat(buffer, assignmentUnit, valueOffset, valueLength, 745, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.OPEN_INTEREST:
                hasOpenInterest = true;
                openInterest = getFloat(buffer, openInterest, valueOffset, valueLength, 746, CODEC_VALIDATION_ENABLED);
                break;
