...
import com.swiftalgo.ms.codecs.fix50sp2.builder.SecurityListEncoder;
...
public class SecurityListDecoder extends CommonDecoderImpl implements ApplicationSequenceControlDecoder, SecListGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(42);
 ...
 return SecurityRequestResult.NULL_VAL;
    ...
    public SecurityListEncoder toEncoder(final SecurityListEncoder encoder)
    {
        ...
        final SecListGrpEncoder secListGrp = encoder.secListGrp();        if (hasNoRelatedSymGroupCounter)
        {
            final int size = this.noRelatedSymGroupCounter;
            RelatedSymGroupDecoder relatedSymGroup = this.relatedSymGroup;
            RelatedSymGroupEncoder relatedSymGroupEncoder = secListGrp.relatedSymGroup(size);
