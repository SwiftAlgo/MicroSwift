...
public interface RelSymDerivSecGrpDecoder 
{



public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, SecondaryPriceLimitsDecoder, InstrumentExtensionDecoder, InstrmtLegGrpDecoder
{
 ...
 return DeliveryForm.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public RelSymDerivSecGrpEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RelSymDerivSecGrpEncoder.RelatedSymGroupEncoder)encoder);
    }

    public RelSymDerivSecGrpEncoder.RelatedSymGroupEncoder toEncoder(final RelSymDerivSecGrpEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final RelSymDerivSecGrpDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final RelSymDerivSecGrpDecoder parent)
        {
            this.parent = parent;
        }
