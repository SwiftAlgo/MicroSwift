...
public class TrdAllocGrpEncoder
{
...
public static class AllocsGroupEncoder
{
    ...
    private static final int allocClearingFeeIndicatorHeaderLength = 5;
    private static final byte[] allocClearingFeeIndicatorHeader = new byte[] {49, 49, 51, 54, (byte) '='};
    ...
    private final MutableDirectBuffer allocClearingFeeIndicator = new UnsafeBuffer();

    private int allocClearingFeeIndicatorOffset = 0;

    private int allocClearingFeeIndicatorLength = 0;

    public AllocsGroupEncoder allocClearingFeeIndicator(final DirectBuffer value, final int offset, final int length)
    {
        allocClearingFeeIndicator.wrap(value);
        allocClearingFeeIndicatorOffset = offset;
        allocClearingFeeIndicatorLength = length;
        return this;
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final DirectBuffer value, final int length)
    {
        return allocClearingFeeIndicator(value, 0, length);
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final DirectBuffer value)
    {
        return allocClearingFeeIndicator(value, 0, value.capacity());
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final byte[] value, final int offset, final int length)
    {
        allocClearingFeeIndicator.wrap(value);
        allocClearingFeeIndicatorOffset = offset;
        allocClearingFeeIndicatorLength = length;
    ...
    public AllocsGroupEncoder allocClearingFeeIndicatorAsCopy(final byte[] value, final int offset, final int length)
    {
        copyInto(allocClearingFeeIndicator, value, offset, length);
        allocClearingFeeIndicatorOffset = offset;
        allocClearingFeeIndicatorLength = length;
        return this;
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final byte[] value, final int length)
    {
        return allocClearingFeeIndicator(value, 0, length);
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final byte[] value)
    {
        return allocClearingFeeIndicator(value, 0, value.length);
    }

    public boolean hasAllocClearingFeeIndicator()
    {
        return allocClearingFeeIndicatorLength > 0;
    }

    public MutableDirectBuffer allocClearingFeeIndicator()
    {
    ...
    {
        return allocClearingFeeIndicator.getStringWithoutLengthAscii(allocClearingFeeIndicatorOffset, allocClearingFeeIndicatorLength);
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final CharSequence value)
    {
        toBytes(value, allocClearingFeeIndicator);
        allocClearingFeeIndicatorOffset = 0;
        allocClearingFeeIndicatorLength = value.length();
        return this;
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
            allocClearingFeeIndicator.wrap(buffer);
            allocClearingFeeIndicatorOffset = value.offset();
            allocClearingFeeIndicatorLength = value.length();
        }
        return this;
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final char[] value)
    {
        return allocClearingFeeIndicator(value, 0, value.length);
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final char[] value, final int length)
    {
        return allocClearingFeeIndicator(value, 0, length);
    }

    public AllocsGroupEncoder allocClearingFeeIndicator(final char[] value, final int offset, final int length)
    {
        toBytes(value, allocClearingFeeIndicator, offset, length);
        allocClearingFeeIndicatorOffset = 0;
        allocClearingFeeIndicatorLength = length;
        return this;
    }
    ...
    public int encode(final MutableAsciiBuffer buffer, final int offset, final int remainingElements)
    {
        ...
        if (allocClearingFeeIndicatorLength > 0)
        {
            buffer.putBytes(position, allocClearingFeeIndicatorHeader, 0, allocClearingFeeIndicatorHeaderLength);
            position += allocClearingFeeIndicatorHeaderLength;
            buffer.putBytes(position, allocClearingFeeIndicator, allocClearingFeeIndicatorOffset, allocClearingFeeIndicatorLength);
            position += allocClearingFeeIndicatorLength;
            buffer.putSeparator(position);
            position++;
        }
        if (next != null)
    ...
    {
        allocClearingFeeIndicatorLength = 0;
    }
    ...
    builder.append("\n");
        ...
        if (hasAllocClearingFeeIndicator())
        {
            ...
            appendBuffer(builder, allocClearingFeeIndicator, allocClearingFeeIndicatorOffset, allocClearingFeeIndicatorLength);
            builder.append("\",\n");
        }
    ...
    public AllocsGroupEncoder copyTo(final AllocsGroupEncoder encoder)
    {
        ...
        if (hasAllocClearingFeeIndicator())
        {
            encoder.allocClearingFeeIndicatorAsCopy(allocClearingFeeIndicator.byteArray(), 0, allocClearingFeeIndicatorLength);
        }
        return encoder;
    }
    ...
    public TrdAllocGrpEncoder noAllocsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"TrdAllocGrp\",\n");
        if (hasNoAllocsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public TrdAllocGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((TrdAllocGrpEncoder)encoder);
    }

    public TrdAllocGrpEncoder copyTo(final TrdAllocGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoAllocsGroupCounter)
        {
