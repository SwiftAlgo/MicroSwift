...
public class InstrmtLegSecListGrpEncoder
{
...
public static class LegsGroupEncoder
{
    ...
    public InstrmtLegSecListGrpEncoder noLegsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"InstrmtLegSecListGrp\",\n");
        if (hasNoLegsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public InstrmtLegSecListGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((InstrmtLegSecListGrpEncoder)encoder);
    }

    public InstrmtLegSecListGrpEncoder copyTo(final InstrmtLegSecListGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoLegsGroupCounter)
        {
