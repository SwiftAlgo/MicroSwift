...
public enum OrdType implements CharRepresentable
{
    ...
    private static final IntHashSet intSet = new IntHashSet(48);
        static
    {
        intSet.add('1');
        intSet.add('2');
