...
public interface SecLstUpdRelSymsLegGrpDecoder 
{
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, LegBenchmarkCurveDataDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(120);
 ...
 return LegSwapType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public SecLstUpdRelSymsLegGrpEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecLstUpdRelSymsLegGrpEncoder.LegsGroupEncoder)encoder);
    }

    public SecLstUpdRelSymsLegGrpEncoder.LegsGroupEncoder toEncoder(final SecLstUpdRelSymsLegGrpEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final SecLstUpdRelSymsLegGrpDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final SecLstUpdRelSymsLegGrpDecoder parent)
        {
            this.parent = parent;
        }
