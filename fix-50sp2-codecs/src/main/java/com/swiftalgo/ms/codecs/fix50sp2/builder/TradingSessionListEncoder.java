...
public class TradingSessionListEncoder implements Encoder
{
    ...
    public TradingSessionListEncoder()
    {
        header.msgType("BJ");
    }
    ...
    public TradingSessionListEncoder tradSesReqID(final DirectBuffer value, final int offset, final int length)
    {
    ...
    public TradingSessionListEncoder tradSesReqID(final DirectBuffer value, final int length)
    {
        return tradSesReqID(value, 0, length);
    }

    public TradingSessionListEncoder tradSesReqID(final DirectBuffer value)
    {
        return tradSesReqID(value, 0, value.capacity());
    }

    public TradingSessionListEncoder tradSesReqID(final byte[] value, final int offset, final int length)
    {
        tradSesReqID.wrap(value);
        tradSesReqIDOffset = offset;
        tradSesReqIDLength = length;
    ...
    public TradingSessionListEncoder tradSesReqIDAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public TradingSessionListEncoder tradSesReqID(final byte[] value, final int length)
    {
        return tradSesReqID(value, 0, length);
    }

    public TradingSessionListEncoder tradSesReqID(final byte[] value)
    {
    ...
    public TradingSessionListEncoder tradSesReqID(final CharSequence value)
    {
    ...
    public TradingSessionListEncoder tradSesReqID(final AsciiSequenceView value)
    {
    ...
    public TradingSessionListEncoder tradSesReqID(final char[] value)
    {
        return tradSesReqID(value, 0, value.length);
    }

    public TradingSessionListEncoder tradSesReqID(final char[] value, final int length)
    {
        return tradSesReqID(value, 0, length);
    }

    public TradingSessionListEncoder tradSesReqID(final char[] value, final int offset, final int length)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        builder.append("\"MessageName\": \"TradingSessionList\",\n");
     ...
     * {@inheritDoc}
     */
    public TradingSessionListEncoder copyTo(final Encoder encoder)
    {
        return copyTo((TradingSessionListEncoder)encoder);
    }

    public TradingSessionListEncoder copyTo(final TradingSessionListEncoder encoder)
    {
        encoder.reset();
