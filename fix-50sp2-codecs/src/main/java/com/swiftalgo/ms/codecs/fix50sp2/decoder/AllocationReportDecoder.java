...
import com.swiftalgo.ms.codecs.fix50sp2.builder.AllocationReportEncoder;
...
public class AllocationReportDecoder extends CommonDecoderImpl implements OrdAllocGrpDecoder, ExecAllocGrpDecoder, InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, PartiesDecoder, StipulationsDecoder, YieldDataDecoder, PositionAmountDataDecoder, AllocGrpDecoder, RateSourceDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(348);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(348);
    ...
    public final IntHashSet messageFields = new IntHashSet(968);
