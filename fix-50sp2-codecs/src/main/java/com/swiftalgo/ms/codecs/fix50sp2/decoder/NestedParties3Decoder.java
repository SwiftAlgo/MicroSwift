...
public class Nested3PartyIDsGroupDecoder extends CommonDecoderImpl implements NstdPtys3SubGrpDecoder
{
    ...
    public NestedParties3Encoder.Nested3PartyIDsGroupEncoder toEncoder(final NestedParties3Encoder.Nested3PartyIDsGroupEncoder encoder)
    {
        ...
        final NstdPtys3SubGrpEncoder nstdPtys3SubGrp = encoder.nstdPtys3SubGrp();        if (hasNoNested3PartySubIDsGroupCounter)
        {
            final int size = this.noNested3PartySubIDsGroupCounter;
            Nested3PartySubIDsGroupDecoder nested3PartySubIDsGroup = this.nested3PartySubIDsGroup;
            Nested3PartySubIDsGroupEncoder nested3PartySubIDsGroupEncoder = nstdPtys3SubGrp.nested3PartySubIDsGroup(size);
