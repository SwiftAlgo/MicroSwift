...
import com.swiftalgo.ms.codecs.fix50sp2.builder.CollateralInquiryAckEncoder;
...
public class CollateralInquiryAckDecoder extends CommonDecoderImpl implements CollInqQualGrpDecoder, PartiesDecoder, ExecCollGrpDecoder, TrdCollGrpDecoder, InstrumentDecoder, FinancingDetailsDecoder, InstrmtLegGrpDecoder, UndInstrmtGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(666);
