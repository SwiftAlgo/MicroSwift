...
public interface QuotReqRjctGrpDecoder 
{



public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, OrderQtyDataDecoder, StipulationsDecoder, QuotReqLegsGrpDecoder, QuotQualGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, PartiesDecoder
{
    ...
    public final IntHashSet ALL_GROUP_FIELDS = new IntHashSet(46);
 ...
 return YieldType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public QuotReqRjctGrpEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuotReqRjctGrpEncoder.RelatedSymGroupEncoder)encoder);
    }

    public QuotReqRjctGrpEncoder.RelatedSymGroupEncoder toEncoder(final QuotReqRjctGrpEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuotReqRjctGrpDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final QuotReqRjctGrpDecoder parent)
        {
            this.parent = parent;
        }
