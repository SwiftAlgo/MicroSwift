...
public class TradingSessionStatusEncoder implements Encoder
{
    ...
    private static final int tradSesEventHeaderLength = 5;
    private static final byte[] tradSesEventHeader = new byte[] {49, 51, 54, 56, (byte) '='};
    ...
    public TradingSessionStatusEncoder marketID(final DirectBuffer value, final int offset, final int length)
    {
        marketID.wrap(value);
    ...
    public TradingSessionStatusEncoder marketID(final DirectBuffer value, final int length)
    {
        return marketID(value, 0, length);
    }

    public TradingSessionStatusEncoder marketID(final DirectBuffer value)
    {
        return marketID(value, 0, value.capacity());
    }

    public TradingSessionStatusEncoder marketID(final byte[] value, final int offset, final int length)
    {
        marketID.wrap(value);
        marketIDOffset = offset;
        marketIDLength = length;
    ...
    public TradingSessionStatusEncoder marketIDAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public TradingSessionStatusEncoder marketID(final byte[] value, final int length)
    {
        return marketID(value, 0, length);
    }

    public TradingSessionStatusEncoder marketID(final byte[] value)
    {
    ...
    public TradingSessionStatusEncoder marketID(final CharSequence value)
    {
    ...
    public TradingSessionStatusEncoder marketID(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public TradingSessionStatusEncoder marketID(final char[] value)
    {
        return marketID(value, 0, value.length);
    }

    public TradingSessionStatusEncoder marketID(final char[] value, final int length)
    {
        return marketID(value, 0, length);
    }

    public TradingSessionStatusEncoder marketID(final char[] value, final int offset, final int length)
    {
    ...
    public TradingSessionStatusEncoder marketSegmentID(final DirectBuffer value, final int offset, final int length)
    {
    ...
    public TradingSessionStatusEncoder marketSegmentID(final DirectBuffer value, final int length)
    {
        return marketSegmentID(value, 0, length);
    }

    public TradingSessionStatusEncoder marketSegmentID(final DirectBuffer value)
    {
        return marketSegmentID(value, 0, value.capacity());
    }

    public TradingSessionStatusEncoder marketSegmentID(final byte[] value, final int offset, final int length)
    {
        marketSegmentID.wrap(value);
        marketSegmentIDOffset = offset;
        marketSegmentIDLength = length;
    ...
    public TradingSessionStatusEncoder marketSegmentIDAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public TradingSessionStatusEncoder marketSegmentID(final byte[] value, final int length)
    {
        return marketSegmentID(value, 0, length);
    }

    public TradingSessionStatusEncoder marketSegmentID(final byte[] value)
    {
    ...
    public TradingSessionStatusEncoder marketSegmentID(final CharSequence value)
    {
    ...
    public TradingSessionStatusEncoder marketSegmentID(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public TradingSessionStatusEncoder marketSegmentID(final char[] value)
    {
        return marketSegmentID(value, 0, value.length);
    }

    public TradingSessionStatusEncoder marketSegmentID(final char[] value, final int length)
    {
        return marketSegmentID(value, 0, length);
    }

    public TradingSessionStatusEncoder marketSegmentID(final char[] value, final int offset, final int length)
    {
    ...
    public TradingSessionStatusEncoder tradingSessionID(TradingSessionID value)
    {
    ...
    public TradingSessionStatusEncoder tradingSessionSubID(TradingSessionSubID value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    private int tradSesEvent;

    private boolean hasTradSesEvent;

    public boolean hasTradSesEvent()
    {
        return hasTradSesEvent;
    }

    public TradingSessionStatusEncoder tradSesEvent(int value)
    {
        tradSesEvent = value;
        hasTradSesEvent = true;
        return this;
    }

    public int tradSesEvent()
    {
        return tradSesEvent;
    }

    public TradingSessionStatusEncoder tradSesEvent(TradSesEvent value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
            if (value == TradSesEvent.ARTIO_UNKNOWN)
            {
                throw new EncodingException("Invalid Value Field: tradSesEvent Value: " + value );
            }
            if (value == TradSesEvent.NULL_VAL)
            {
                return this;
            }
        }
        return tradSesEvent(value.representation());
    }
    ...
    public long encode(final MutableAsciiBuffer buffer, final int offset)
    {
        ...
        if (hasTradSesEvent)
        {
            buffer.putBytes(position, tradSesEventHeader, 0, tradSesEventHeaderLength);
            position += tradSesEventHeaderLength;
            position += buffer.putIntAscii(position, tradSesEvent);
            buffer.putSeparator(position);
            position++;
        }
    ...
    public void resetTradSesEvent()
    {
        hasTradSesEvent = false;
    }
    ...
    public TradingSessionStatusEncoder copyTo(final TradingSessionStatusEncoder encoder)
    {
        ...
        if (hasTradSesEvent())
        {
            encoder.tradSesEvent(this.tradSesEvent());
        }
