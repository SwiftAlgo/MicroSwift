...
public enum MassCancelResponse implements CharRepresentable
{
    ...
    public static MassCancelResponse decode(final int representation)
    {
        ...
        {
        case '0': return CANCEL_REQUEST_REJECTED_SEE_MASSCANCELREJECTREASON;
        ...
        case 'B': return CANCEL_ORDERS_FOR_A_SECURITIES_ISSUER;
        case 'C': return CANCEL_ORDERS_FOR_ISSUER_OF_UNDERLYING_SECURITY;
        default:
