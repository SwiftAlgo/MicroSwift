...
import com.swiftalgo.ms.codecs.fix50sp2.builder.OrderMassCancelReportEncoder;
...
public class OrderMassCancelReportDecoder extends CommonDecoderImpl implements AffectedOrdGrpDecoder, NotAffectedOrdersGrpDecoder, PartiesDecoder, TargetPartiesDecoder, InstrumentDecoder, UnderlyingInstrumentDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(342);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(342);
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !MassCancelRejectReason.isValid(massCancelRejectReason()))
        {
            invalidTagId = 532;
            rejectReason = 5;
            return false;
    ...
    private int massCancelRejectReason = MISSING_INT;
 ...
 return MassCancelRejectReason.NULL_VAL;
        return MassCancelRejectReason.decode(massCancelRejectReason);
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.MASS_CANCEL_REJECT_REASON:
                ...
                massCancelRejectReason = getInt(buffer, valueOffset, endOfField, 532, CODEC_VALIDATION_ENABLED);
                break;
