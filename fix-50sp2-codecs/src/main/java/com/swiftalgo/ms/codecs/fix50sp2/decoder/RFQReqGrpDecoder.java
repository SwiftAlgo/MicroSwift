...
public interface RFQReqGrpDecoder 
{
...
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder
{
 ...
 return TradingSessionSubID.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public RFQReqGrpEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RFQReqGrpEncoder.RelatedSymGroupEncoder)encoder);
    }

    public RFQReqGrpEncoder.RelatedSymGroupEncoder toEncoder(final RFQReqGrpEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final RFQReqGrpDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final RFQReqGrpDecoder parent)
        {
            this.parent = parent;
        }
