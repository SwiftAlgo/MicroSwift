...
import com.swiftalgo.ms.codecs.fix50sp2.builder.SecurityDefinitionUpdateReportEncoder;
...
public class SecurityDefinitionUpdateReportDecoder extends CommonDecoderImpl implements ApplicationSequenceControlDecoder, InstrumentDecoder, InstrumentExtensionDecoder, UndInstrmtGrpDecoder, StipulationsDecoder, InstrmtLegGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MarketSegmentGrpDecoder, MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 20546L;

    public static final String MESSAGE_TYPE_AS_STRING = "BP";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(762);
    ...
    public int securityResponseType()
    {
        if (!hasSecurityResponseType)
        {
            throw new IllegalArgumentException("No value for optional field: SecurityResponseType");
        }
    ...
    {
        if (!hasSecurityResponseType)
 return SecurityResponseType.NULL_VAL;
 ...
 return YieldType.NULL_VAL;
    ...
    {
        // Decode SecurityDefinitionUpdateReport
     ...
     * {@inheritDoc}
     */
    public SecurityDefinitionUpdateReportEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityDefinitionUpdateReportEncoder)encoder);
    }

    public SecurityDefinitionUpdateReportEncoder toEncoder(final SecurityDefinitionUpdateReportEncoder encoder)
    {
        encoder.reset();
        ...
        final MarketSegmentGrpEncoder marketSegmentGrp = encoder.marketSegmentGrp();        if (hasNoMarketSegmentsGroupCounter)
        {
