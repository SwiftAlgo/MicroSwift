...
import com.swiftalgo.ms.codecs.fix50sp2.builder.QuoteResponseEncoder;
...
public class QuoteResponseDecoder extends CommonDecoderImpl implements QuotQualGrpDecoder, PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, OrderQtyDataDecoder, StipulationsDecoder, LegQuotGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MessageDecoder
{
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(336);
    ...
    public final IntHashSet messageFields = new IntHashSet(816);
