...
public class ApplIDRequestGrpEncoder
{
...
public static class ApplIDsGroupEncoder
{
    ...
    public ApplIDRequestGrpEncoder noApplIDsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"ApplIDRequestGrp\",\n");
        if (hasNoApplIDsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public ApplIDRequestGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((ApplIDRequestGrpEncoder)encoder);
    }

    public ApplIDRequestGrpEncoder copyTo(final ApplIDRequestGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoApplIDsGroupCounter)
        {
