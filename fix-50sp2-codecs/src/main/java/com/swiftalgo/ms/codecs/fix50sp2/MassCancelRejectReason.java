...
public enum MassCancelRejectReason implements IntRepresentable
{
    ...
    MassCancelRejectReason(final int representation)
    {
    ...
    public static MassCancelRejectReason decode(final int representation)
    {
        ...
        case 2: return INVALID_OR_UNKOWN_UNDERLYING_SECURITY;
        ...
        case 8: return INVALID_OR_UNKOWN_MARKET_SEGMENT;
