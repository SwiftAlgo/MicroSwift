...
public static class MDEntriesGroupEncoder
{
    ...
    public MDFullGrpEncoder noMDEntriesGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"MDFullGrp\",\n");
        if (hasNoMDEntriesGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public MDFullGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((MDFullGrpEncoder)encoder);
    }

    public MDFullGrpEncoder copyTo(final MDFullGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoMDEntriesGroupCounter)
        {
