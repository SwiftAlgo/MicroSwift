...
public interface QuotEntryGrpDecoder 
{
...
public class QuoteEntriesGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrmtLegGrpDecoder
{
 ...
 return OrderCapacity.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public QuotEntryGrpEncoder.QuoteEntriesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuotEntryGrpEncoder.QuoteEntriesGroupEncoder)encoder);
    }

    public QuotEntryGrpEncoder.QuoteEntriesGroupEncoder toEncoder(final QuotEntryGrpEncoder.QuoteEntriesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuotEntryGrpDecoder parent;
        private int remainder;
        private QuoteEntriesGroupDecoder current;

        public QuoteEntriesGroupIterator(final QuotEntryGrpDecoder parent)
        {
            this.parent = parent;
        }
