...
import com.swiftalgo.ms.codecs.fix50sp2.builder.CollateralReportEncoder;
...
public class CollateralReportDecoder extends CommonDecoderImpl implements PartiesDecoder, ExecCollGrpDecoder, TrdCollGrpDecoder, InstrumentDecoder, FinancingDetailsDecoder, InstrmtLegGrpDecoder, UndInstrmtGrpDecoder, TrdRegTimestampsDecoder, MiscFeesGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, SettlInstructionsDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(282);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(282);
    ...
    public void collRptID(final AsciiSequenceView view)
    {
        view.wrap(buffer, collRptIDOffset, collRptIDLength);
    }
