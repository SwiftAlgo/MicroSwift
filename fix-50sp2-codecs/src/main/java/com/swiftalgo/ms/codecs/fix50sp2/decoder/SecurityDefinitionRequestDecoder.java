...
import com.swiftalgo.ms.codecs.fix50sp2.builder.SecurityDefinitionRequestEncoder;
...
public class SecurityDefinitionRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, UndInstrmtGrpDecoder, StipulationsDecoder, InstrmtLegGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(224);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(224);
    ...
    public final IntHashSet messageFields = new IntHashSet(640);
