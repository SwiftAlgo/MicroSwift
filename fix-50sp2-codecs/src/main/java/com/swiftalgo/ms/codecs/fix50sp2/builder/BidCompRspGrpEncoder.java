...
public class BidCompRspGrpEncoder
{
...
public static class BidComponentsGroupEncoder
{
    ...
    public BidCompRspGrpEncoder noBidComponentsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"BidCompRspGrp\",\n");
        if (hasNoBidComponentsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public BidCompRspGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((BidCompRspGrpEncoder)encoder);
    }

    public BidCompRspGrpEncoder copyTo(final BidCompRspGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoBidComponentsGroupCounter)
        {
