...
public enum CustOrderHandlingInst implements StringRepresentable
{
    ADD_ON_ORDER("ADD"),
    ALL_OR_NONE("AON"),
    CASH_NOT_HELD("CNH"),
    ...
    CustOrderHandlingInst(final String representation)
    {
    ...
    private static final CharArrayMap<CustOrderHandlingInst> charMap;
    static
    {
        final Map<String, CustOrderHandlingInst> stringMap = new HashMap<>();
    ...
    public static CustOrderHandlingInst decode(final CharArrayWrapper key)
    {
        final CustOrderHandlingInst value = charMap.get(key);
        if (value == null)
        {
    ...
    public static CustOrderHandlingInst decode(final String representation)
    {
