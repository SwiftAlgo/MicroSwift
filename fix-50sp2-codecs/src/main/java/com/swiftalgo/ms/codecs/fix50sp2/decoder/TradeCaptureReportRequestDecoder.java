...
import com.swiftalgo.ms.codecs.fix50sp2.builder.TradeCaptureReportRequestEncoder;
...
public class TradeCaptureReportRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder, TrdCapDtGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(260);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(260);
    ...
    public final IntHashSet messageFields = new IntHashSet(692);

    {
        ...
        messageFields.add(Constants.NO_DATES);
 ...
 return ResponseTransportType.NULL_VAL;
    ...
    if (hasNoDatesGroupCounter)
    {
        ...
        {
            indent(builder, level);
            datesGroup.appendTo(builder, level + 1);            if (datesGroup.next() != null)
            {
                builder.append(',');
            }
            builder.append('\n');
    ...
    public TradeCaptureReportRequestEncoder toEncoder(final TradeCaptureReportRequestEncoder encoder)
    {
        ...
        final TrdCapDtGrpEncoder trdCapDtGrp = encoder.trdCapDtGrp();        if (hasNoDatesGroupCounter)
        {
            final int size = this.noDatesGroupCounter;
            DatesGroupDecoder datesGroup = this.datesGroup;
            DatesGroupEncoder datesGroupEncoder = trdCapDtGrp.datesGroup(size);
            for (int i = 0; i < size; i++)
            {
                if (datesGroup != null)
                {
