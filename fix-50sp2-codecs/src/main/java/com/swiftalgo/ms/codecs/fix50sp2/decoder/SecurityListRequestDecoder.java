...
import com.swiftalgo.ms.codecs.fix50sp2.builder.SecurityListRequestEncoder;
...
public class SecurityListRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(218);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(218);
