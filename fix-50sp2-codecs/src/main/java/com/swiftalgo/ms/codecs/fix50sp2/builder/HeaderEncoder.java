...
public class HeaderEncoder implements uk.co.real_logic.artio.builder.SessionHeaderEncoder
{
    ...
    private static final byte[] DEFAULT_BEGIN_STRING="FIXT.1.1".getBytes(StandardCharsets.US_ASCII);
    ...
    private static final byte[] applVerIDHeader = new byte[] {49, 49, 50, 56, (byte) '='};

    private static final int applExtIDHeaderLength = 5;
    private static final byte[] applExtIDHeader = new byte[] {49, 49, 53, 54, (byte) '='};

    private static final int cstmApplVerIDHeaderLength = 5;
    private static final byte[] cstmApplVerIDHeader = new byte[] {49, 49, 50, 57, (byte) '='};
    ...
    private final MutableDirectBuffer applVerID = new UnsafeBuffer();

    private int applVerIDOffset = 0;

    private int applVerIDLength = 0;

    public HeaderEncoder applVerID(final DirectBuffer value, final int offset, final int length)
    {
        applVerID.wrap(value);
        applVerIDOffset = offset;
        applVerIDLength = length;
        return this;
    }

    public HeaderEncoder applVerID(final DirectBuffer value, final int length)
    {
        return applVerID(value, 0, length);
    }

    public HeaderEncoder applVerID(final DirectBuffer value)
    {
        return applVerID(value, 0, value.capacity());
    }

    public HeaderEncoder applVerID(final byte[] value, final int offset, final int length)
    {
        applVerID.wrap(value);
        applVerIDOffset = offset;
        applVerIDLength = length;
    ...
    public HeaderEncoder applVerIDAsCopy(final byte[] value, final int offset, final int length)
    {
        copyInto(applVerID, value, offset, length);
        applVerIDOffset = offset;
        applVerIDLength = length;
        return this;
    }

    public HeaderEncoder applVerID(final byte[] value, final int length)
    {
        return applVerID(value, 0, length);
    }

    public HeaderEncoder applVerID(final byte[] value)
    {
        return applVerID(value, 0, value.length);
    }

    public boolean hasApplVerID()
    {
        return applVerIDLength > 0;
    }

    public MutableDirectBuffer applVerID()
    {
        return applVerID;
    }
    ...
    {
        return applVerID.getStringWithoutLengthAscii(applVerIDOffset, applVerIDLength);
    }

    public HeaderEncoder applVerID(final CharSequence value)
    {
        toBytes(value, applVerID);
        applVerIDOffset = 0;
        applVerIDLength = value.length();
        return this;
    }

    public HeaderEncoder applVerID(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
            applVerID.wrap(buffer);
            applVerIDOffset = value.offset();
            applVerIDLength = value.length();
        }
        return this;
    }

    public HeaderEncoder applVerID(final char[] value)
    {
        return applVerID(value, 0, value.length);
    }

    public HeaderEncoder applVerID(final char[] value, final int length)
    {
        return applVerID(value, 0, length);
    }

    public HeaderEncoder applVerID(final char[] value, final int offset, final int length)
    {
        toBytes(value, applVerID, offset, length);
        applVerIDOffset = 0;
        applVerIDLength = length;
        return this;
    }
    ...
    public HeaderEncoder applVerID(ApplVerID value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
            if (value == ApplVerID.ARTIO_UNKNOWN)
            {
                throw new EncodingException("Invalid Value Field: applVerID Value: " + value );
            }
            if (value == ApplVerID.NULL_VAL)
            {
                return this;
            }
        }
        return applVerID(value.representation());
    }
    ...
    private final MutableDirectBuffer cstmApplVerID = new UnsafeBuffer();

    private int cstmApplVerIDOffset = 0;

    private int cstmApplVerIDLength = 0;

    public HeaderEncoder cstmApplVerID(final DirectBuffer value, final int offset, final int length)
    {
        cstmApplVerID.wrap(value);
        cstmApplVerIDOffset = offset;
        cstmApplVerIDLength = length;
        return this;
    }

    public HeaderEncoder cstmApplVerID(final DirectBuffer value, final int length)
    {
        return cstmApplVerID(value, 0, length);
    }

    public HeaderEncoder cstmApplVerID(final DirectBuffer value)
    {
        return cstmApplVerID(value, 0, value.capacity());
    }

    public HeaderEncoder cstmApplVerID(final byte[] value, final int offset, final int length)
    {
        cstmApplVerID.wrap(value);
        cstmApplVerIDOffset = offset;
        cstmApplVerIDLength = length;
    ...
    public HeaderEncoder cstmApplVerIDAsCopy(final byte[] value, final int offset, final int length)
    {
        copyInto(cstmApplVerID, value, offset, length);
        cstmApplVerIDOffset = offset;
        cstmApplVerIDLength = length;
        return this;
    }

    public HeaderEncoder cstmApplVerID(final byte[] value, final int length)
    {
        return cstmApplVerID(value, 0, length);
    }

    public HeaderEncoder cstmApplVerID(final byte[] value)
    {
        return cstmApplVerID(value, 0, value.length);
    }

    public boolean hasCstmApplVerID()
    {
        return cstmApplVerIDLength > 0;
    }

    public MutableDirectBuffer cstmApplVerID()
    {
    ...
    {
        return cstmApplVerID.getStringWithoutLengthAscii(cstmApplVerIDOffset, cstmApplVerIDLength);
    }

    public HeaderEncoder cstmApplVerID(final CharSequence value)
    {
        toBytes(value, cstmApplVerID);
        cstmApplVerIDOffset = 0;
        cstmApplVerIDLength = value.length();
        return this;
    }

    public HeaderEncoder cstmApplVerID(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
            cstmApplVerID.wrap(buffer);
            cstmApplVerIDOffset = value.offset();
            cstmApplVerIDLength = value.length();
        }
        return this;
    }

    public HeaderEncoder cstmApplVerID(final char[] value)
    {
        return cstmApplVerID(value, 0, value.length);
    }

    public HeaderEncoder cstmApplVerID(final char[] value, final int length)
    {
        return cstmApplVerID(value, 0, length);
    }

    public HeaderEncoder cstmApplVerID(final char[] value, final int offset, final int length)
    {
        toBytes(value, cstmApplVerID, offset, length);
        cstmApplVerIDOffset = 0;
        cstmApplVerIDLength = length;
        return this;
    }
    ...
    public long startMessage(final MutableAsciiBuffer buffer, final int offset)
    {
        ...
        if (applVerIDLength > 0)
        {
            buffer.putBytes(position, applVerIDHeader, 0, applVerIDHeaderLength);
            position += applVerIDHeaderLength;
            buffer.putBytes(position, applVerID, applVerIDOffset, applVerIDLength);
            position += applVerIDLength;
            buffer.putSeparator(position);
            position++;
        }
        ...
        if (hasApplExtID)
        {
            buffer.putBytes(position, applExtIDHeader, 0, applExtIDHeaderLength);
            position += applExtIDHeaderLength;
            position += buffer.putIntAscii(position, applExtID);
            buffer.putSeparator(position);
            position++;
        }

        if (cstmApplVerIDLength > 0)
        {
            buffer.putBytes(position, cstmApplVerIDHeader, 0, cstmApplVerIDHeaderLength);
            position += cstmApplVerIDHeaderLength;
            buffer.putBytes(position, cstmApplVerID, cstmApplVerIDOffset, cstmApplVerIDLength);
            position += cstmApplVerIDLength;
            buffer.putSeparator(position);
            position++;
        }
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasApplVerID())
        {
            ...
            appendBuffer(builder, applVerID, applVerIDOffset, applVerIDLength);
            builder.append("\",\n");
        }
        ...
        if (hasCstmApplVerID())
        {
            ...
            appendBuffer(builder, cstmApplVerID, cstmApplVerIDOffset, cstmApplVerIDLength);
            builder.append("\",\n");
        }
    ...
    public HeaderEncoder copyTo(final HeaderEncoder encoder)
    {
        ...
        if (hasApplVerID())
        {
            encoder.applVerIDAsCopy(applVerID.byteArray(), 0, applVerIDLength);
        }

        if (hasApplExtID())
        {
            encoder.applExtID(this.applExtID());
        }

        if (hasCstmApplVerID())
        {
            encoder.cstmApplVerIDAsCopy(cstmApplVerID.byteArray(), 0, cstmApplVerIDLength);
        }
