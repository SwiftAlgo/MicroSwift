...
public class RelSymDerivSecUpdGrpEncoder
{
...
public static class RelatedSymGroupEncoder
{
    ...
    public RelSymDerivSecUpdGrpEncoder noRelatedSymGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"RelSymDerivSecUpdGrp\",\n");
        if (hasNoRelatedSymGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public RelSymDerivSecUpdGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((RelSymDerivSecUpdGrpEncoder)encoder);
    }

    public RelSymDerivSecUpdGrpEncoder copyTo(final RelSymDerivSecUpdGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoRelatedSymGroupCounter)
        {
