...
import com.swiftalgo.ms.codecs.fix50sp2.builder.AllocationInstructionEncoder;
...
public class AllocationInstructionDecoder extends CommonDecoderImpl implements OrdAllocGrpDecoder, ExecAllocGrpDecoder, InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, PartiesDecoder, StipulationsDecoder, YieldDataDecoder, PositionAmountDataDecoder, AllocGrpDecoder, RateSourceDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(958);
