...
import com.swiftalgo.ms.codecs.fix50sp2.builder.OrderCancelRequestEncoder;
...
public class OrderCancelRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, OrderQtyDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(228);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(228);
