...
import com.swiftalgo.ms.codecs.fix50sp2.builder.CollateralRequestEncoder;
...
public class CollateralRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, ExecCollGrpDecoder, TrdCollGrpDecoder, InstrumentDecoder, FinancingDetailsDecoder, InstrmtLegGrpDecoder, UndInstrmtCollGrpDecoder, TrdRegTimestampsDecoder, MiscFeesGrpDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(726);
