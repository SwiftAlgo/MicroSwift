...
public class SettlObligGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, PartiesDecoder, SettlDetailsDecoder
{
 ...
 return CPProgram.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public SettlObligGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SettlObligGroupEncoder)encoder);
    }

    public SettlObligGroupEncoder toEncoder(final SettlObligGroupEncoder encoder)
    {
        encoder.reset();
        if (hasNetGrossInd())
        {
