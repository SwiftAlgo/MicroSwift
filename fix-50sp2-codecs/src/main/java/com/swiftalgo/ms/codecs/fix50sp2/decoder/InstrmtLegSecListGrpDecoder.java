...
public interface InstrmtLegSecListGrpDecoder 
{
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, LegBenchmarkCurveDataDecoder
{
 ...
 return LegSwapType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public InstrmtLegSecListGrpEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((InstrmtLegSecListGrpEncoder.LegsGroupEncoder)encoder);
    }

    public InstrmtLegSecListGrpEncoder.LegsGroupEncoder toEncoder(final InstrmtLegSecListGrpEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final InstrmtLegSecListGrpDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final InstrmtLegSecListGrpDecoder parent)
        {
            this.parent = parent;
        }
