...
public interface InstrmtStrkPxGrpDecoder 
{



public class StrikesGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, UndInstrmtGrpDecoder
{
 ...
 return Side.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public InstrmtStrkPxGrpEncoder.StrikesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((InstrmtStrkPxGrpEncoder.StrikesGroupEncoder)encoder);
    }

    public InstrmtStrkPxGrpEncoder.StrikesGroupEncoder toEncoder(final InstrmtStrkPxGrpEncoder.StrikesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final InstrmtStrkPxGrpDecoder parent;
        private int remainder;
        private StrikesGroupDecoder current;

        public StrikesGroupIterator(final InstrmtStrkPxGrpDecoder parent)
        {
            this.parent = parent;
        }
