...
import com.swiftalgo.ms.codecs.fix44.builder.CollateralAssignmentEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.CollateralAssignmentEncoder.ExecsGroupEncoder;
import static com.swiftalgo.ms.codecs.fix44.builder.CollateralAssignmentEncoder.TradesGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.CollateralAssignmentEncoder.LegsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.CollateralAssignmentEncoder.UnderlyingsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.CollateralAssignmentEncoder.MiscFeesGroupEncoder;
...
public class CollateralAssignmentDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, SettlInstructionsDataDecoder, MessageDecoder
{
    ...
    public void collAsgnRefID(final AsciiSequenceView view)
    {
        if (!hasCollAsgnRefID)
        {
            throw new IllegalArgumentException("No value for optional field: CollAsgnRefID");
        ...
        view.wrap(buffer, collAsgnRefIDOffset, collAsgnRefIDLength);
    }
