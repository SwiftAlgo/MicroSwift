...
import com.swiftalgo.ms.codecs.fix44.builder.OrderMassCancelReportEncoder;
import static com.swiftalgo.ms.codecs.fix44.builder.OrderMassCancelReportEncoder.AffectedOrdersGroupEncoder;
...
public class OrderMassCancelReportDecoder extends CommonDecoderImpl implements InstrumentDecoder, UnderlyingInstrumentDecoder, MessageDecoder
{
    ...
    public void massCancelRejectReason(final AsciiSequenceView view)
    {
        if (!hasMassCancelRejectReason)
        {
            throw new IllegalArgumentException("No value for optional field: MassCancelRejectReason");
        ...
        view.wrap(buffer, massCancelRejectReasonOffset, massCancelRejectReasonLength);
    }
...
public class AffectedOrdersGroupDecoder extends CommonDecoderImpl
{
     ...
     * {@inheritDoc}
     */
    public AffectedOrdersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AffectedOrdersGroupEncoder)encoder);
    }

    public AffectedOrdersGroupEncoder toEncoder(final AffectedOrdersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasOrigClOrdID())
        {
