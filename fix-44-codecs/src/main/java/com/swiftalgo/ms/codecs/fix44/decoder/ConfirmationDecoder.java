...
import com.swiftalgo.ms.codecs.fix44.builder.ConfirmationEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.ConfirmationEncoder.OrdersGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.ConfirmationEncoder.UnderlyingsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.ConfirmationEncoder.LegsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.ConfirmationEncoder.CapacitiesGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.ConfirmationEncoder.MiscFeesGroupEncoder;
...
public class ConfirmationDecoder extends CommonDecoderImpl implements PartiesDecoder, TrdRegTimestampsDecoder, InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, YieldDataDecoder, SpreadOrBenchmarkCurveDataDecoder, SettlInstructionsDataDecoder, CommissionDataDecoder, StipulationsDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.NO_UNDERLYINGS);
            REQUIRED_FIELDS.add(Constants.NO_LEGS);
