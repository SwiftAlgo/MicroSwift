...
import com.swiftalgo.ms.codecs.fix44.builder.ListStrikePriceEncoder;
import static com.swiftalgo.ms.codecs.fix44.builder.ListStrikePriceEncoder.StrikesGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.ListStrikePriceEncoder.UnderlyingsGroupEncoder;
...
public class StrikesGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder
{
 ...
 return PutOrCall.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public StrikesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((StrikesGroupEncoder)encoder);
    }

    public StrikesGroupEncoder toEncoder(final StrikesGroupEncoder encoder)
    {
        encoder.reset();
