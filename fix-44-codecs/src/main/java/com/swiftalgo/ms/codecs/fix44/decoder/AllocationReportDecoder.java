...
import com.swiftalgo.ms.codecs.fix44.builder.AllocationReportEncoder;
import static com.swiftalgo.ms.codecs.fix44.builder.AllocationReportEncoder.OrdersGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.AllocationReportEncoder.ExecsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.AllocationReportEncoder.UnderlyingsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.AllocationReportEncoder.LegsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.AllocationReportEncoder.AllocsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.AllocationReportEncoder.AllocsGroupEncoder.MiscFeesGroupEncoder;
import static com.swiftalgo.ms.codecs.fix44.builder.AllocationReportEncoder.AllocsGroupEncoder.ClearingInstructionsGroupEncoder;
...
public class AllocationReportDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, SpreadOrBenchmarkCurveDataDecoder, PartiesDecoder, StipulationsDecoder, YieldDataDecoder, MessageDecoder
{
    ...
    public void allocReportRefID(final AsciiSequenceView view)
    {
        if (!hasAllocReportRefID)
        {
            throw new IllegalArgumentException("No value for optional field: AllocReportRefID");
        ...
        view.wrap(buffer, allocReportRefIDOffset, allocReportRefIDLength);
    }
