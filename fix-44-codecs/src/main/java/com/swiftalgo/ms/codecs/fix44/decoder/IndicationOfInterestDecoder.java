...
import com.swiftalgo.ms.codecs.fix44.builder.IndicationOfInterestEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.IndicationOfInterestEncoder.UnderlyingsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.IndicationOfInterestEncoder.LegsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.IndicationOfInterestEncoder.IOIQualifiersGroupEncoder;
import static com.swiftalgo.ms.codecs.fix44.builder.IndicationOfInterestEncoder.RoutingIDsGroupEncoder;
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder
{
    ...
    public void legIOIQty(final AsciiSequenceView view)
    {
        if (!hasLegIOIQty)
        {
            throw new IllegalArgumentException("No value for optional field: LegIOIQty");
        ...
        view.wrap(buffer, legIOIQtyOffset, legIOIQtyLength);
    }
...
public class RoutingIDsGroupDecoder extends CommonDecoderImpl
{
 ...
 return RoutingType.NULL_VAL;
    ...
    public void routingID(final AsciiSequenceView view)
    {
        if (!hasRoutingID)
        {
            throw new IllegalArgumentException("No value for optional field: RoutingID");
        ...
        view.wrap(buffer, routingIDOffset, routingIDLength);
    }
