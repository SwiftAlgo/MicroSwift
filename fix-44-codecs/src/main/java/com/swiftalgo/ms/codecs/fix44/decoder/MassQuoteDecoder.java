...
import com.swiftalgo.ms.codecs.fix44.builder.MassQuoteEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.MassQuoteEncoder.QuoteSetsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.MassQuoteEncoder.QuoteSetsGroupEncoder.QuoteEntriesGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.MassQuoteEncoder.QuoteSetsGroupEncoder.QuoteEntriesGroupEncoder.LegsGroupEncoder;
...
public class MassQuoteDecoder extends CommonDecoderImpl implements PartiesDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.NO_QUOTE_SETS);
        }
    }
...
public class QuoteSetsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.NO_QUOTE_ENTRIES);
        }
    }
