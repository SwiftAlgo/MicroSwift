...
import com.swiftalgo.ms.codecs.fix44.builder.PositionMaintenanceReportEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.PositionMaintenanceReportEncoder.LegsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.PositionMaintenanceReportEncoder.UnderlyingsGroupEncoder;
...
import static com.swiftalgo.ms.codecs.fix44.builder.PositionMaintenanceReportEncoder.TradingSessionsGroupEncoder;
import com.swiftalgo.ms.codecs.fix44.builder.PositionQtyEncoder;
import static com.swiftalgo.ms.codecs.fix44.builder.PositionQtyEncoder.PositionsGroupEncoder;
...
public class PositionMaintenanceReportDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, PositionQtyDecoder, PositionAmountDataDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.NO_POSITIONS);
            REQUIRED_FIELDS.add(Constants.NO_POS_AMT);
        }
    }
    ...
    public void origPosReqRefID(final AsciiSequenceView view)
    {
        view.wrap(buffer, origPosReqRefIDOffset, origPosReqRefIDLength);
    }
