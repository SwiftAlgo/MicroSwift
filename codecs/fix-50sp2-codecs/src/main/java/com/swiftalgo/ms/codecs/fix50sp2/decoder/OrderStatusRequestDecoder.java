...
import com.swiftalgo.ms.codecs.fix50sp2.builder.OrderStatusRequestEncoder;
...
public class OrderStatusRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(506);
