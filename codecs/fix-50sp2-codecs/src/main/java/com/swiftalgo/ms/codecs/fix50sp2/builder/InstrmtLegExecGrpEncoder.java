...
public class InstrmtLegExecGrpEncoder
{
...
public static class LegsGroupEncoder
{
    ...
    public InstrmtLegExecGrpEncoder noLegsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"InstrmtLegExecGrp\",\n");
        if (hasNoLegsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public InstrmtLegExecGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((InstrmtLegExecGrpEncoder)encoder);
    }

    public InstrmtLegExecGrpEncoder copyTo(final InstrmtLegExecGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoLegsGroupCounter)
        {
