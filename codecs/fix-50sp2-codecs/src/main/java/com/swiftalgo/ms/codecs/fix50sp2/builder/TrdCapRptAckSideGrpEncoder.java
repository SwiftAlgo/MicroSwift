...
public class TrdCapRptAckSideGrpEncoder
{
...
public static class SidesGroupEncoder
{
    ...
    public SidesGroupEncoder copyTo(final SidesGroupEncoder encoder)
    {
        ...
        tradeReportOrderDetail.copyTo(encoder.tradeReportOrderDetail());

        sideTrdRegTS.copyTo(encoder.sideTrdRegTS());        return encoder;
    }
    ...
    public TrdCapRptAckSideGrpEncoder noSidesGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"TrdCapRptAckSideGrp\",\n");
        if (hasNoSidesGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public TrdCapRptAckSideGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((TrdCapRptAckSideGrpEncoder)encoder);
    }

    public TrdCapRptAckSideGrpEncoder copyTo(final TrdCapRptAckSideGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoSidesGroupCounter)
        {
