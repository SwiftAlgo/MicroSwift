...
import com.swiftalgo.ms.codecs.fix50sp2.builder.StreamAssignmentReportACKEncoder;


public class StreamAssignmentReportACKDecoder extends CommonDecoderImpl implements MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.STREAM_ASGN_ACK_TYPE);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !StreamAsgnAckType.isValid(streamAsgnAckType()))
        {
            invalidTagId = 1503;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 17731L;

    public static final String MESSAGE_TYPE_AS_STRING = "CE";
...

    {
        ...
        messageFields.add(Constants.STREAM_ASGN_ACK_TYPE);
    ...
    private int streamAsgnAckType = MISSING_INT;
    ...
    private final CharArrayWrapper streamAsgnAckTypeWrapper = new CharArrayWrapper();
    public StreamAsgnAckType streamAsgnAckTypeAsEnum()
    {
        return StreamAsgnAckType.decode(streamAsgnAckType);
    }
 ...
 return StreamAsgnRejReason.NULL_VAL;
    ...
    {
        // Decode StreamAssignmentReportACK
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.STREAM_ASGN_ACK_TYPE:
                streamAsgnAckType = getInt(buffer, valueOffset, endOfField, 1503, CODEC_VALIDATION_ENABLED);
                break;
     ...
     * {@inheritDoc}
     */
    public StreamAssignmentReportACKEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((StreamAssignmentReportACKEncoder)encoder);
    }

    public StreamAssignmentReportACKEncoder toEncoder(final StreamAssignmentReportACKEncoder encoder)
    {
        encoder.reset();
