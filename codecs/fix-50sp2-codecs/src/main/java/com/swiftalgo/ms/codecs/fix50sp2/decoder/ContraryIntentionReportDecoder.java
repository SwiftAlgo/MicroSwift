...
public class ContraryIntentionReportDecoder extends CommonDecoderImpl implements ApplicationSequenceControlDecoder, PartiesDecoder, ExpirationQtyDecoder, InstrumentDecoder, UndInstrmtGrpDecoder, MessageDecoder
{
...

    {
        ...
        messageFields.add(Constants.NO_EXPIRATION_GROUP_COUNTER);
    ...
    private final CharArrayWrapper contIntRptIDWrapper = new CharArrayWrapper();
    ...
    private final CharArrayWrapper inputSourceWrapper = new CharArrayWrapper();
 ...
 return CPProgram.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.NO_EXPIRATION_GROUP_COUNTER:
