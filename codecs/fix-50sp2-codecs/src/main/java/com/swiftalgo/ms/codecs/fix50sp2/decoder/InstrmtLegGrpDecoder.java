...
public interface InstrmtLegGrpDecoder 
{
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
     ...
     * {@inheritDoc}
     */
    public InstrmtLegGrpEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((InstrmtLegGrpEncoder.LegsGroupEncoder)encoder);
    }

    public InstrmtLegGrpEncoder.LegsGroupEncoder toEncoder(final InstrmtLegGrpEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final InstrmtLegGrpDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final InstrmtLegGrpDecoder parent)
        {
            this.parent = parent;
        }
