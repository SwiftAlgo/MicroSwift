...
import com.swiftalgo.ms.codecs.fix50sp2.builder.NetworkCounterpartySystemStatusRequestEncoder;
...
public class NetworkCounterpartySystemStatusRequestDecoder extends CommonDecoderImpl implements CompIDReqGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(78);
    ...
    {
        // Decode NetworkCounterpartySystemStatusRequest
     ...
     * {@inheritDoc}
     */
    public NetworkCounterpartySystemStatusRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NetworkCounterpartySystemStatusRequestEncoder)encoder);
    }

    public NetworkCounterpartySystemStatusRequestEncoder toEncoder(final NetworkCounterpartySystemStatusRequestEncoder encoder)
    {
        encoder.reset();
        ...
        final CompIDReqGrpEncoder compIDReqGrp = encoder.compIDReqGrp();        if (hasNoCompIDsGroupCounter)
        {
            final int size = this.noCompIDsGroupCounter;
            CompIDsGroupDecoder compIDsGroup = this.compIDsGroup;
            CompIDsGroupEncoder compIDsGroupEncoder = compIDReqGrp.compIDsGroup(size);
