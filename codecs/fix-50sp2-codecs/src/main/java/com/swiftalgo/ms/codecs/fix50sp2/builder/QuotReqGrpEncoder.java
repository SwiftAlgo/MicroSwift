...
public class QuotReqGrpEncoder
{
...
public static class RelatedSymGroupEncoder
{
    ...
    public RelatedSymGroupEncoder minQty(DecimalFloat value)
    {
        minQty.set(value);
        hasMinQty = true;
        return this;
    ...
    public RelatedSymGroupEncoder minQty(long value, int scale)
    {
    ...
    public RelatedSymGroupEncoder settlCurrency(final DirectBuffer value, final int offset, final int length)
    {
    ...
    public RelatedSymGroupEncoder settlCurrency(final DirectBuffer value, final int length)
    {
        return settlCurrency(value, 0, length);
    }

    public RelatedSymGroupEncoder settlCurrency(final DirectBuffer value)
    {
        return settlCurrency(value, 0, value.capacity());
    }

    public RelatedSymGroupEncoder settlCurrency(final byte[] value, final int offset, final int length)
    {
        settlCurrency.wrap(value);
        settlCurrencyOffset = offset;
        settlCurrencyLength = length;
    ...
    public RelatedSymGroupEncoder settlCurrencyAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public RelatedSymGroupEncoder settlCurrency(final byte[] value, final int length)
    {
        return settlCurrency(value, 0, length);
    }

    public RelatedSymGroupEncoder settlCurrency(final byte[] value)
    {
    ...
    public RelatedSymGroupEncoder settlCurrency(final CharSequence value)
    {
    ...
    public RelatedSymGroupEncoder settlCurrency(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public RelatedSymGroupEncoder settlCurrency(final char[] value)
    {
        return settlCurrency(value, 0, value.length);
    }

    public RelatedSymGroupEncoder settlCurrency(final char[] value, final int length)
    {
        return settlCurrency(value, 0, length);
    }

    public RelatedSymGroupEncoder settlCurrency(final char[] value, final int offset, final int length)
    {
    ...
    public QuotReqGrpEncoder noRelatedSymGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"QuotReqGrp\",\n");
        if (hasNoRelatedSymGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public QuotReqGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((QuotReqGrpEncoder)encoder);
    }

    public QuotReqGrpEncoder copyTo(final QuotReqGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoRelatedSymGroupCounter)
        {
