...
public interface TrdCapRptSideGrpDecoder 
{



public class SidesGroupDecoder extends CommonDecoderImpl implements PartiesDecoder, ClrInstGrpDecoder, CommissionDataDecoder, ContAmtGrpDecoder, StipulationsDecoder, MiscFeesGrpDecoder, TrdAllocGrpDecoder, SideTrdRegTSDecoder, SettlDetailsDecoder, TradeReportOrderDetailDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.EXCHANGE_SPECIAL_INSTRUCTIONS);
            GROUP_FIELDS.add(Constants.ORDER_CATEGORY);
            GROUP_FIELDS.add(Constants.SIDE_LIQUIDITY_IND);
    ...
    public final IntHashSet ALL_GROUP_FIELDS = new IntHashSet(108);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            ALL_GROUP_FIELDS.add(Constants.EXCHANGE_SPECIAL_INSTRUCTIONS);
            ALL_GROUP_FIELDS.add(Constants.ORDER_CATEGORY);
            ALL_GROUP_FIELDS.add(Constants.SIDE_LIQUIDITY_IND);
        }
    }
    ...
    private IntHashSet seenFields = new IntHashSet(128);
 ...
 return PreallocMethod.NULL_VAL;
    ...
    private char[] exchangeSpecialInstructions = new char[1];

    private boolean hasExchangeSpecialInstructions;

    public char[] exchangeSpecialInstructions()
    {
        if (!hasExchangeSpecialInstructions)
        {
            throw new IllegalArgumentException("No value for optional field: ExchangeSpecialInstructions");
        }
    ...
    {
        return hasExchangeSpecialInstructions;
    }


    private int exchangeSpecialInstructionsOffset;

    private int exchangeSpecialInstructionsLength;

    public int exchangeSpecialInstructionsLength()
    {
        if (!hasExchangeSpecialInstructions)
        {
            throw new IllegalArgumentException("No value for optional field: ExchangeSpecialInstructions");
        ...
        return exchangeSpecialInstructionsLength;
    }

    public String exchangeSpecialInstructionsAsString()
    {
        return hasExchangeSpecialInstructions ? new String(exchangeSpecialInstructions, 0, exchangeSpecialInstructionsLength) : null;
    }

    public void exchangeSpecialInstructions(final AsciiSequenceView view)
    {
        if (!hasExchangeSpecialInstructions)
        {
            throw new IllegalArgumentException("No value for optional field: ExchangeSpecialInstructions");
        ...
        view.wrap(buffer, exchangeSpecialInstructionsOffset, exchangeSpecialInstructionsLength);
    }


    private final CharArrayWrapper exchangeSpecialInstructionsWrapper = new CharArrayWrapper();
 ...
 return OrderCategory.NULL_VAL;
    ...
    private int sideLiquidityInd = MISSING_INT;
    ...
    public int sideLiquidityInd()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: SideLiquidityInd");
        }
 ...
 return LotType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.EXCHANGE_SPECIAL_INSTRUCTIONS:
                hasExchangeSpecialInstructions = true;
                exchangeSpecialInstructions = buffer.getChars(exchangeSpecialInstructions, valueOffset, valueLength);
                exchangeSpecialInstructionsOffset = valueOffset;
                exchangeSpecialInstructionsLength = valueLength;
                break;
            ...
            case Constants.SIDE_LIQUIDITY_IND:
                hasSideLiquidityInd = true;
                sideLiquidityInd = getInt(buffer, valueOffset, endOfField, 1444, CODEC_VALIDATION_ENABLED);
                break;
    ...
    {
        hasExchangeSpecialInstructions = false;
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasExchangeSpecialInstructions())
        {
            ...
            builder.append(this.exchangeSpecialInstructions(), 0, exchangeSpecialInstructionsLength());
            builder.append("\",\n");
        }
     ...
     * {@inheritDoc}
     */
    public TrdCapRptSideGrpEncoder.SidesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((TrdCapRptSideGrpEncoder.SidesGroupEncoder)encoder);
    }

    public TrdCapRptSideGrpEncoder.SidesGroupEncoder toEncoder(final TrdCapRptSideGrpEncoder.SidesGroupEncoder encoder)
    {
        encoder.reset();
        ...
        if (hasExchangeSpecialInstructions())
        {
            encoder.exchangeSpecialInstructions(this.exchangeSpecialInstructions(), 0, exchangeSpecialInstructionsLength());
        }
    ...
    {
        private final TrdCapRptSideGrpDecoder parent;
        private int remainder;
        private SidesGroupDecoder current;

        public SidesGroupIterator(final TrdCapRptSideGrpDecoder parent)
        {
            this.parent = parent;
        }
