...
public interface InstrmtMDReqGrpDecoder 
{



public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder
{
 ...
 return SettlType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public InstrmtMDReqGrpEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((InstrmtMDReqGrpEncoder.RelatedSymGroupEncoder)encoder);
    }

    public InstrmtMDReqGrpEncoder.RelatedSymGroupEncoder toEncoder(final InstrmtMDReqGrpEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final InstrmtMDReqGrpDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final InstrmtMDReqGrpDecoder parent)
        {
            this.parent = parent;
        }
