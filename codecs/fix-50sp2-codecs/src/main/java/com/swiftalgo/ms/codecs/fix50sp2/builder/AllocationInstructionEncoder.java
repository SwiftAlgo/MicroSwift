...
public class AllocationInstructionEncoder implements Encoder
{
    ...
    public AllocationInstructionEncoder matchType(MatchType value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public AllocationInstructionEncoder tradingSessionID(TradingSessionID value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public AllocationInstructionEncoder tradingSessionSubID(TradingSessionSubID value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public AllocationInstructionEncoder settlType(final DirectBuffer value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder settlType(final DirectBuffer value, final int length)
    {
        return settlType(value, 0, length);
    }

    public AllocationInstructionEncoder settlType(final DirectBuffer value)
    {
        return settlType(value, 0, value.capacity());
    }

    public AllocationInstructionEncoder settlType(final byte[] value, final int offset, final int length)
    {
        settlType.wrap(value);
        settlTypeOffset = offset;
        settlTypeLength = length;
    ...
    public AllocationInstructionEncoder settlTypeAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder settlType(final byte[] value, final int length)
    {
        return settlType(value, 0, length);
    }

    public AllocationInstructionEncoder settlType(final byte[] value)
    {
    ...
    public AllocationInstructionEncoder settlType(final CharSequence value)
    {
    ...
    public AllocationInstructionEncoder settlType(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public AllocationInstructionEncoder settlType(final char[] value)
    {
        return settlType(value, 0, value.length);
    }

    public AllocationInstructionEncoder settlType(final char[] value, final int length)
    {
        return settlType(value, 0, length);
    }

    public AllocationInstructionEncoder settlType(final char[] value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder avgPxIndicator(int value)
    {
    ...
    public AllocationInstructionEncoder avgPxIndicator(AvgPxIndicator value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public AllocationInstructionEncoder clearingBusinessDate(final DirectBuffer value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder clearingBusinessDate(final DirectBuffer value, final int length)
    {
        return clearingBusinessDate(value, 0, length);
    }

    public AllocationInstructionEncoder clearingBusinessDate(final DirectBuffer value)
    {
        return clearingBusinessDate(value, 0, value.capacity());
    }

    public AllocationInstructionEncoder clearingBusinessDate(final byte[] value, final int offset, final int length)
    {
        clearingBusinessDate.wrap(value);
        clearingBusinessDateOffset = offset;
        clearingBusinessDateLength = length;
    ...
    public AllocationInstructionEncoder clearingBusinessDateAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder clearingBusinessDate(final byte[] value, final int length)
    {
        return clearingBusinessDate(value, 0, length);
    }

    public AllocationInstructionEncoder clearingBusinessDate(final byte[] value)
    {
    ...
    public AllocationInstructionEncoder trdType(int value)
    {
        trdType = value;
        hasTrdType = true;
        return this;
    ...
    public AllocationInstructionEncoder trdType(TrdType value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public AllocationInstructionEncoder trdSubType(int value)
    {
        trdSubType = value;
        hasTrdSubType = true;
        return this;
    ...
    public AllocationInstructionEncoder trdSubType(TrdSubType value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public AllocationInstructionEncoder custOrderCapacity(int value)
    {
    ...
    public AllocationInstructionEncoder custOrderCapacity(CustOrderCapacity value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public AllocationInstructionEncoder tradeInputSource(final DirectBuffer value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder tradeInputSource(final DirectBuffer value, final int length)
    {
        return tradeInputSource(value, 0, length);
    }

    public AllocationInstructionEncoder tradeInputSource(final DirectBuffer value)
    {
        return tradeInputSource(value, 0, value.capacity());
    }

    public AllocationInstructionEncoder tradeInputSource(final byte[] value, final int offset, final int length)
    {
        tradeInputSource.wrap(value);
        tradeInputSourceOffset = offset;
        tradeInputSourceLength = length;
    ...
    public AllocationInstructionEncoder tradeInputSourceAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder tradeInputSource(final byte[] value, final int length)
    {
        return tradeInputSource(value, 0, length);
    }

    public AllocationInstructionEncoder tradeInputSource(final byte[] value)
    {
    ...
    public AllocationInstructionEncoder tradeInputSource(final CharSequence value)
    {
    ...
    public AllocationInstructionEncoder tradeInputSource(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public AllocationInstructionEncoder tradeInputSource(final char[] value)
    {
        return tradeInputSource(value, 0, value.length);
    }

    public AllocationInstructionEncoder tradeInputSource(final char[] value, final int length)
    {
        return tradeInputSource(value, 0, length);
    }

    public AllocationInstructionEncoder tradeInputSource(final char[] value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder multiLegReportingType(char value)
    {
    ...
    public AllocationInstructionEncoder multiLegReportingType(MultiLegReportingType value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public AllocationInstructionEncoder messageEventSource(final DirectBuffer value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder messageEventSource(final DirectBuffer value, final int length)
    {
        return messageEventSource(value, 0, length);
    }

    public AllocationInstructionEncoder messageEventSource(final DirectBuffer value)
    {
        return messageEventSource(value, 0, value.capacity());
    }

    public AllocationInstructionEncoder messageEventSource(final byte[] value, final int offset, final int length)
    {
        messageEventSource.wrap(value);
        messageEventSourceOffset = offset;
        messageEventSourceLength = length;
    ...
    public AllocationInstructionEncoder messageEventSourceAsCopy(final byte[] value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder messageEventSource(final byte[] value, final int length)
    {
        return messageEventSource(value, 0, length);
    }

    public AllocationInstructionEncoder messageEventSource(final byte[] value)
    {
    ...
    public AllocationInstructionEncoder messageEventSource(final CharSequence value)
    {
    ...
    public AllocationInstructionEncoder messageEventSource(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
    ...
    public AllocationInstructionEncoder messageEventSource(final char[] value)
    {
        return messageEventSource(value, 0, value.length);
    }

    public AllocationInstructionEncoder messageEventSource(final char[] value, final int length)
    {
        return messageEventSource(value, 0, length);
    }

    public AllocationInstructionEncoder messageEventSource(final char[] value, final int offset, final int length)
    {
    ...
    public AllocationInstructionEncoder rndPx(DecimalFloat value)
    {
        rndPx.set(value);
        hasRndPx = true;
        return this;
    ...
    public AllocationInstructionEncoder rndPx(long value, int scale)
    {
