...
public interface QuotReqLegsGrpDecoder 
{
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, NestedPartiesDecoder, LegBenchmarkCurveDataDecoder
{
 ...
 return LegSwapType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public QuotReqLegsGrpEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuotReqLegsGrpEncoder.LegsGroupEncoder)encoder);
    }

    public QuotReqLegsGrpEncoder.LegsGroupEncoder toEncoder(final QuotReqLegsGrpEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuotReqLegsGrpDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final QuotReqLegsGrpDecoder parent)
        {
            this.parent = parent;
        }
