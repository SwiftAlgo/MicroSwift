...
public class QuotSetGrpEncoder
{
...
public static class QuoteSetsGroupEncoder
{
    ...
    private final QuotEntryGrpEncoder quotEntryGrp = new QuotEntryGrpEncoder();
    public QuotEntryGrpEncoder quotEntryGrp()
    {
        return quotEntryGrp;
    }
    ...
    public int encode(final MutableAsciiBuffer buffer, final int offset, final int remainingElements)
    {
        ...
        if (hasLastFragment)
        {
            ...
            position += quotEntryGrp.encode(buffer, position);
        if (next != null)
        {
    ...
    indent(builder, level);
    builder.append("\"QuotEntryGrp\": ");
    quotEntryGrp.appendTo(builder, level + 1);
    builder.append("\n");
    ...
    public QuoteSetsGroupEncoder copyTo(final QuoteSetsGroupEncoder encoder)
    {
        ...
        quotEntryGrp.copyTo(encoder.quotEntryGrp());        return encoder;
    }
    ...
    public QuotSetGrpEncoder noQuoteSetsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"QuotSetGrp\",\n");
        if (hasNoQuoteSetsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public QuotSetGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((QuotSetGrpEncoder)encoder);
    }

    public QuotSetGrpEncoder copyTo(final QuotSetGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoQuoteSetsGroupCounter)
        {
