...
import com.swiftalgo.ms.codecs.fix50sp2.builder.OrderCancelReplaceRequestEncoder;
...
public class OrderCancelReplaceRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, PreAllocGrpDecoder, DisplayInstructionDecoder, TrdgSesGrpDecoder, InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, OrderQtyDataDecoder, TriggeringInstructionDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, StrategyParametersGrpDecoder, CommissionDataDecoder, TrdRegTimestampsDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(460);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(460);
    ...
    public final IntHashSet messageFields = new IntHashSet(818);
