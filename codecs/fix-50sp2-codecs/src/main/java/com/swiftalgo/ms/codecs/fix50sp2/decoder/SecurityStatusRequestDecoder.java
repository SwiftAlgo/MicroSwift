...
import com.swiftalgo.ms.codecs.fix50sp2.builder.SecurityStatusRequestEncoder;
...
public class SecurityStatusRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(596);
