...
public enum SecurityIDSource implements StringRepresentable
{
    ...
    static
    {
        ...
        stringMap.put("J", OPTION_PRICE_REPORTING_AUTHORITY);
        stringMap.put("K", ISDA_FPML_PRODUCT_URL);
        stringMap.put("L", LETTER_OF_CREDIT);
        stringMap.put("M", MARKETPLACE_ASSIGNED_IDENTIFIER);
    ...
    public static SecurityIDSource decode(final String representation)
    {
        ...
        case "J": return OPTION_PRICE_REPORTING_AUTHORITY;
        case "K": return ISDA_FPML_PRODUCT_URL;
        case "L": return LETTER_OF_CREDIT;
        case "M": return MARKETPLACE_ASSIGNED_IDENTIFIER;
        default:
            return ARTIO_UNKNOWN;
        }
    }
