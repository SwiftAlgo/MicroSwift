...
import com.swiftalgo.ms.codecs.fix50sp2.builder.StrmAsgnReqInstrmtGrpEncoder;
import static com.swiftalgo.ms.codecs.fix50sp2.builder.StrmAsgnReqInstrmtGrpEncoder.RelatedSymGroupEncoder;
...
public interface StrmAsgnReqInstrmtGrpDecoder 
{
...
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(174);
 ...
 return SettlType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public StrmAsgnReqInstrmtGrpEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((StrmAsgnReqInstrmtGrpEncoder.RelatedSymGroupEncoder)encoder);
    }

    public StrmAsgnReqInstrmtGrpEncoder.RelatedSymGroupEncoder toEncoder(final StrmAsgnReqInstrmtGrpEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final StrmAsgnReqInstrmtGrpDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final StrmAsgnReqInstrmtGrpDecoder parent)
        {
            this.parent = parent;
        }
