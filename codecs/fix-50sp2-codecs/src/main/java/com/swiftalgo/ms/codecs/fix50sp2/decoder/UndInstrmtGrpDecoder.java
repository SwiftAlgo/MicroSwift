...
public interface UndInstrmtGrpDecoder 
{
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingFXRateCalc.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public UndInstrmtGrpEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((UndInstrmtGrpEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public UndInstrmtGrpEncoder.UnderlyingsGroupEncoder toEncoder(final UndInstrmtGrpEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final UndInstrmtGrpDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final UndInstrmtGrpDecoder parent)
        {
            this.parent = parent;
        }
