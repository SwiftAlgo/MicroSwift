...
public interface InstrmtLegExecGrpDecoder 
{



public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, LegPreAllocGrpDecoder, NestedParties3Decoder
{
 ...
 return LegSwapType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public InstrmtLegExecGrpEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((InstrmtLegExecGrpEncoder.LegsGroupEncoder)encoder);
    }

    public InstrmtLegExecGrpEncoder.LegsGroupEncoder toEncoder(final InstrmtLegExecGrpEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final InstrmtLegExecGrpDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final InstrmtLegExecGrpDecoder parent)
        {
            this.parent = parent;
        }
