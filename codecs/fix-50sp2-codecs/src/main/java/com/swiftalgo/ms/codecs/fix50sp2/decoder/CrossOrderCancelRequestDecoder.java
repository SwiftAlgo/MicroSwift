...
import com.swiftalgo.ms.codecs.fix50sp2.builder.CrossOrderCancelRequestEncoder;
...
public class CrossOrderCancelRequestDecoder extends CommonDecoderImpl implements RootPartiesDecoder, SideCrossOrdCxlGrpDecoder, InstrumentDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder, MessageDecoder
{
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(182);
    ...
    public final IntHashSet messageFields = new IntHashSet(650);
 ...
 return CPProgram.NULL_VAL;
    ...
    public CrossOrderCancelRequestEncoder toEncoder(final CrossOrderCancelRequestEncoder encoder)
    {
        ...
        final SideCrossOrdCxlGrpEncoder sideCrossOrdCxlGrp = encoder.sideCrossOrdCxlGrp();        if (hasNoSidesGroupCounter)
        {
            final int size = this.noSidesGroupCounter;
            SidesGroupDecoder sidesGroup = this.sidesGroup;
            SidesGroupEncoder sidesGroupEncoder = sideCrossOrdCxlGrp.sidesGroup(size);
            for (int i = 0; i < size; i++)
            {
                if (sidesGroup != null)
                {
