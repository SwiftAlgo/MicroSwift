...
public enum TradeReportType implements IntRepresentable
{
    ...
    public static TradeReportType decode(final int representation)
    {
        ...
        case 7: return TRADE_BREAK;
        case 8: return DEFAULTED;
        case 9: return INVALID_CMTA;
        case 10: return PENDED;
        case 11: return ALLEGED_NEW;
        case 12: return ALLEGED_ADDENDUM;
        case 13: return ALLEGED_NO_WAS;
        case 14: return ALLEGED_TRADE_REPORT_CANCEL;
        case 15: return ALLEGED_TRADE_BREAK;
        default:
