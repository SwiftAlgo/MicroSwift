...
public class UndInstrmtGrpEncoder
{
...
public static class UnderlyingsGroupEncoder
{
    ...
    public UndInstrmtGrpEncoder noUnderlyingsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"UndInstrmtGrp\",\n");
        if (hasNoUnderlyingsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public UndInstrmtGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((UndInstrmtGrpEncoder)encoder);
    }

    public UndInstrmtGrpEncoder copyTo(final UndInstrmtGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoUnderlyingsGroupCounter)
        {
