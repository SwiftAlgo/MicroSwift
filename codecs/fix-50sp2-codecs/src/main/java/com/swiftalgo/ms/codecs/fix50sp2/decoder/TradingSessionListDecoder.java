...
import com.swiftalgo.ms.codecs.fix50sp2.builder.TradingSessionListEncoder;
...
public class TradingSessionListDecoder extends CommonDecoderImpl implements ApplicationSequenceControlDecoder, TrdSessLstGrpDecoder, MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 19010L;

    public static final String MESSAGE_TYPE_AS_STRING = "BJ";
     ...
     * {@inheritDoc}
     */
    public TradingSessionListEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((TradingSessionListEncoder)encoder);
    }

    public TradingSessionListEncoder toEncoder(final TradingSessionListEncoder encoder)
    {
        encoder.reset();
