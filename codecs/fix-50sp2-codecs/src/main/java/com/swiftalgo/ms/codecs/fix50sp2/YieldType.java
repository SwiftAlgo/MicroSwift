...
public enum YieldType implements StringRepresentable
{
    ...
    static
    {
        ...
        stringMap.put("AVGMATURITY", YIELD_TO_AVG_MATURITY);
        ...
        stringMap.put("GOVTEQUIV", GVNT_EQUIVALENT_YIELD);
    ...
    public static YieldType decode(final String representation)
    {
        ...
        case "AVGMATURITY": return YIELD_TO_AVG_MATURITY;
        ...
        case "GOVTEQUIV": return GVNT_EQUIVALENT_YIELD;
