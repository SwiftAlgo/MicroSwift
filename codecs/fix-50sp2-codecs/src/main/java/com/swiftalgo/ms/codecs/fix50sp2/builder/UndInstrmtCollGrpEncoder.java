...
public class UndInstrmtCollGrpEncoder
{
...
public static class UnderlyingsGroupEncoder
{
    ...
    public UndInstrmtCollGrpEncoder noUnderlyingsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"UndInstrmtCollGrp\",\n");
        if (hasNoUnderlyingsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public UndInstrmtCollGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((UndInstrmtCollGrpEncoder)encoder);
    }

    public UndInstrmtCollGrpEncoder copyTo(final UndInstrmtCollGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoUnderlyingsGroupCounter)
        {
