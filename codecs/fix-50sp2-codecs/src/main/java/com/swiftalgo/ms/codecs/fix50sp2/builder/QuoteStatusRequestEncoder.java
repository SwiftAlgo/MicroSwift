...
public class QuoteStatusRequestEncoder implements Encoder
{
    ...
    public QuoteStatusRequestEncoder tradingSessionID(TradingSessionID value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
    ...
    public QuoteStatusRequestEncoder tradingSessionSubID(TradingSessionSubID value)
    {
        if (CODEC_VALIDATION_ENABLED)
        {
