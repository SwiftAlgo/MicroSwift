...
public interface LegQuotStatGrpDecoder 
{
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, NestedPartiesDecoder
{
 ...
 return LegSwapType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public LegQuotStatGrpEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((LegQuotStatGrpEncoder.LegsGroupEncoder)encoder);
    }

    public LegQuotStatGrpEncoder.LegsGroupEncoder toEncoder(final LegQuotStatGrpEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final LegQuotStatGrpDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final LegQuotStatGrpDecoder parent)
        {
            this.parent = parent;
        }
