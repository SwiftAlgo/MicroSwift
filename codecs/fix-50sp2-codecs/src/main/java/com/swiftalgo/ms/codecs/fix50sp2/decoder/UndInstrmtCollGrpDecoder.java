...
public interface UndInstrmtCollGrpDecoder 
{
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(140);
 ...
 return CollAction.NULL_VAL;
    ...
    {
        private final UndInstrmtCollGrpDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final UndInstrmtCollGrpDecoder parent)
        {
            this.parent = parent;
        }
