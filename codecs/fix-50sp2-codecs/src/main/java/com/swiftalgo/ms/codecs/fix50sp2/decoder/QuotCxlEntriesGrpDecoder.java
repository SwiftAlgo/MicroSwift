...
public interface QuotCxlEntriesGrpDecoder 
{



public class QuoteEntriesGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, UndInstrmtGrpDecoder, InstrmtLegGrpDecoder
{
 ...
 return DeliveryType.NULL_VAL;
     ...
     * {@inheritDoc}
     */
    public QuotCxlEntriesGrpEncoder.QuoteEntriesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuotCxlEntriesGrpEncoder.QuoteEntriesGroupEncoder)encoder);
    }

    public QuotCxlEntriesGrpEncoder.QuoteEntriesGroupEncoder toEncoder(final QuotCxlEntriesGrpEncoder.QuoteEntriesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuotCxlEntriesGrpDecoder parent;
        private int remainder;
        private QuoteEntriesGroupDecoder current;

        public QuoteEntriesGroupIterator(final QuotCxlEntriesGrpDecoder parent)
        {
            this.parent = parent;
        }
