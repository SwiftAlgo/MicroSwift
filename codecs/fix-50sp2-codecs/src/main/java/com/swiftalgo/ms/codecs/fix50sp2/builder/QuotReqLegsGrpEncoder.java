...
public class QuotReqLegsGrpEncoder
{
...
public static class LegsGroupEncoder
{
    ...
    public QuotReqLegsGrpEncoder noLegsGroupCounter(int value)
    {
    ...
    {
        builder.append("{\n");        indent(builder, level);
        builder.append("\"MessageName\": \"QuotReqLegsGrp\",\n");
        if (hasNoLegsGroupCounter)
        {
            indent(builder, level);
     ...
     * {@inheritDoc}
     */
    public QuotReqLegsGrpEncoder copyTo(final Encoder encoder)
    {
        return copyTo((QuotReqLegsGrpEncoder)encoder);
    }

    public QuotReqLegsGrpEncoder copyTo(final QuotReqLegsGrpEncoder encoder)
    {
        encoder.reset();
        if (hasNoLegsGroupCounter)
        {
