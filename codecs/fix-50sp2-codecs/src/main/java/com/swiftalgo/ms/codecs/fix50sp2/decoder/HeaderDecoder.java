...
public class HeaderDecoder extends CommonDecoderImpl implements SessionHeaderDecoder
{
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(58);
    ...
    public boolean validate()
    {
        ...
        if (hasApplVerID)
        {
        applVerIDWrapper.wrap(this.applVerID(), applVerIDLength);
 ...
 return ApplVerID.NULL_VAL;
    ...
    private int applExtID = MISSING_INT;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.APPL_EXT_ID:
                hasApplExtID = true;
                applExtID = getInt(buffer, valueOffset, endOfField, 1156, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasApplVerID())
        {
            ...
            builder.append(this.applVerID(), 0, applVerIDLength());
            builder.append("\",\n");
        }
        ...
        if (hasCstmApplVerID())
        {
            ...
            builder.append(this.cstmApplVerID(), 0, cstmApplVerIDLength());
            builder.append("\",\n");
        }
    ...
    public HeaderEncoder toEncoder(final HeaderEncoder encoder)
    {
        ...
        if (hasApplVerID())
        {
            encoder.applVerID(this.applVerID(), 0, applVerIDLength());
        }
        ...
        if (hasCstmApplVerID())
        {
            encoder.cstmApplVerID(this.cstmApplVerID(), 0, cstmApplVerIDLength());
        }
